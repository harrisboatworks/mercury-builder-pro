...
const SPECS: SpecInput[] = [
  // 1. Port Hope
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "For aluminum runabouts and small fishing boats heading to Rice Lake, Mercury FourStroke 25–60 HP is common, which lands in the $5,500–$10,000 CAD range for the motor alone. Mid-size fiberglass runabouts often move to FourStroke 90–115 HP, $11,000–$15,000 CAD. Bass boat and pontoon owners who want more bottom-end power look at Pro XS V8 4.6L 175 HP with the Boost option, which gives 25 extra horsepower on demand for 4–6 seconds, common on Rice Lake pontoons with a heavy crew.",
      ...
      },
      {
        ...
        paragraphs: [
          "You drive north, about 30 minutes, and pick up at Gores Landing. We don't ship Mercury motors and we don't deliver to Port Hope. The boat gets rigged, propped, fuel-connected, controls run, and water-tested on Rice Lake before you arrive. Most repowers wrap in 1–3 weeks once the motor lands.",
          'Financing terms are 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC. Deposits run $200 for portable, $500 for mid-range, $1,000 for big-block or Pro XS. For ranges by HP, see the Mercury repower cost guide. If your route is really Port Hope vs Cobourg, our Cobourg page is the closest comparison.',
        ],
      },
    ],
    faqs: [
      ...
      { question: 'Can I finance a Mercury repower from Port Hope?', answer: 'Yes. Financing is 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC. We finalize numbers at quote.' },
    ],
    visitExtra:
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Pontoon owners loading six adults on a Rice Lake party run often ask about Pro XS V8 4.6L 175 HP with the Mercury Boost option, 25 extra horsepower on demand for 4–6 seconds, button press. It costs roughly $1,200–$1,800 CAD on top of the base motor and it\'s the upgrade we see most among pontoon repowers.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "You drive 15 minutes east to Gores Landing and pick up. If your current motor still runs, you can also come by water, same lake, no trailer involved. We don't ship Mercury motors and we don't deliver to Bewdley, even though it's right next door. The motor is rigged, propped, fuel-connected, controls run, and water-tested on Rice Lake before you arrive. Most repowers wrap in 1–3 weeks once the motor lands.",
          'For ranges by HP, see the Mercury repower cost guide. For the lake-wide picture, the Rice Lake page covers same-lake water-test detail. Financing runs 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC.',
        ],
      },
    ],
    faqs: [
  ...
  // 3. Gores Landing
  {
    ...
    keyFacts: [
      ...
      'Mercury Platinum Dealer, selling Mercury since 1965',
      'Typical full repower: $11,000–$40,000 CAD',
    ],
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The combination matters. Mercury Platinum Dealer status is the top dealer tier, re-earned every year on training, sales, service, and customer satisfaction. Selling and servicing Mercury since 1965 means generations of techs here have stayed current with each new Mercury platform, from carbureted two-strokes through current FourStroke V8, Pro XS V8 4.6L, and Verado V10 architecture.',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'For pontoon owners running heavy on weekend lake parties, Pro XS V8 4.6L 175 HP with the Mercury Boost option (25 extra HP for 4–6 seconds on demand) is the upgrade that gets asked about most. Boost costs around $1,200–$1,800 CAD on top of the base motor.',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'Financing runs 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC. Deposits are $200 for portable, $500 for mid-range, $1,000 for big-block, Pro XS, or special-order Verado. Trade-ins: fill the form, we email a CAD figure within one business day. For HP-by-HP ranges, see the Mercury repower cost guide.',
        ],
      },
    ],
    faqs: [
    ...
    visitExtra:
      "We're the repower side of Harris Boat Works in Gores Landing, Mercury Platinum Dealer, selling Mercury since 1965. The same techs who write your quote are the ones who rig and water-test the motor on Rice Lake.",
    related: [
      { label: 'Pricing Reference', href: '/pricing-reference' },
      { label: 'Rice Lake Mercury Repower', href: '/locations/rice-lake-mercury-repower' },
      { label: 'Bewdley', href: '/locations/bewdley' },
      { label: 'Harris Boat Works in Gores Landing, Mercury Platinum Dealer, selling Mercury since 1965', href: 'https://www.harrisboatworks.ca' },
    ],
  },
  ...
  // 4. Roseneath
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Most Roseneath repowers we see land in the Mercury FourStroke 60–115 HP range, $8,000–$14,000 CAD for the motor alone, common on runabouts and aluminum boats. Tiller boats run FourStroke 9.9–25 HP in the $2,800–$5,500 CAD range. Bass boats and pontoon owners often move to Pro XS V8 4.6L 175 HP at $18,000–$22,000 CAD, particularly the Boost variant, 25 extra horsepower on demand for 4–6 seconds on hole-shot.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Financing runs 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC. Deposits are $200 for portable, $500 for mid-range, $1,000 for big-block or Pro XS. For ranges by HP, see the Mercury repower cost guide.',
        ],
      },
    ],
    faqs: [
  ...
  // 5. Hastings
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Hastings boats running the Trent often repower with Mercury FourStroke 115–150 HP, $12,000–$18,000 CAD for the motor alone. Heavier hulls and pontoons commonly move to Pro XS V8 4.6L 175–225 HP, $18,000–$28,000 CAD. The Mercury Boost option, 25 extra horsepower on demand for 4–6 seconds, is popular on pontoons that carry load through the Trent\'s narrow channels and lift lock approaches.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Financing runs 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC. Deposits are $200 for portable, $500 for mid-range, $1,000 for big-block, Pro XS, or special-order Verado. For ranges by HP, see the Mercury repower cost guide.',
        ],
      },
    ],
    faqs: [
      ...
      { question: 'What HP Mercury is common for Hastings and Trent-system boats?', answer: 'Hastings boats running the Trent often repower with Mercury FourStroke 115–150 HP or Pro XS V8 175–225 HP. The Mercury Boost option for an extra 25 HP on demand is common on heavier pontoons working through lift locks.' },
    ],
    visitExtra:
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "The drive is honest. We're not pretending it's a quick trip. Lakefield customers pick HBW because they want a Mercury Platinum Dealer that's been rigging motors since 1965, a shop where the same techs who write the quote are the ones who do the water test, and a place that treats a Stony Lake hull seriously.",
        ],
      },
      {
        heading: 'What Mercury motors do Lakefield boaters typically repower with?',
        paragraphs: [
          'The mix runs heavier in this part of the Kawarthas. Stony Lake hulls (bigger fiberglass runabouts, larger pontoons, bowriders) often repower with Pro XS V8 4.6L 200–300 HP at $20,000–$32,000 CAD, or FourStroke big-block 150–250 HP at $14,000–$28,000 CAD. The Mercury Boost option, 25 extra horsepower on demand for 4–6 seconds, is a frequent add-on at roughly $1,200–$1,800 CAD on top of the base motor.',
      ...
      },
      {
        ...
        paragraphs: [
          "You drive south to Gores Landing, 45 minutes, and pick up. We don't ship Mercury motors and we don't deliver to Lakefield or to Stony Lake cottages. Many Lakefield customers drop the boat with us during the quoting visit and pick it up after the rigging and water test. Typical turnaround is 1–3 weeks once the motor lands, longer on special-order Verado.",
          'Financing runs 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC. Deposits are $200 for portable HP, $500 for mid-range, $1,000 for big-block, Pro XS, or special-order Verado. For ranges by HP, see the Mercury repower cost guide.',
        ],
      },
    ],
    faqs: [
      ...
      { question: 'Can I drop my boat at HBW and pick it up later?', answer: 'Yes. Many Lakefield customers drop the boat with us during the quoting visit and pick it up after the rigging and water test. Typical turnaround is 1–3 weeks once the motor lands.' },
      { question: 'Can Lakefield customers finance a Mercury repower?', answer: 'Yes. Financing is 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC. Deposits are $200 portable, $500 mid-range, $1,000 big-block, Pro XS, or special-order Verado.' },
    ],
    visitExtra:
      "We're the repower side of Harris Boat Works, a family marina in Gores Landing serving boaters since 1947. The same techs who write your quote are the ones who rig and water-test the motor on Rice Lake.",
    related: [
  ...
  // 7. Bridgenorth
  {
    ...
    intro:
      'Harris Boat Works is 40 minutes south of Bridgenorth in Gores Landing, ON, on the south shore of Rice Lake. The drive is roughly 40 km through Peterborough. We are a Mercury Platinum Dealer, selling Mercury since 1965 and family-owned since 1947. Bridgenorth sits on Chemong Lake, a strong pontoon and family-boat lake, a natural fit for Mercury FourStroke and Pro XS repowers. We rig, install, and water-test every Mercury on Rice Lake before pickup at Gores Landing. There is no shipping. Typical full repower: $11,000–$40,000 CAD.',
    keyFacts: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Chemong Lake pontoons are the heart of this customer base. Mercury FourStroke 90–150 HP is the most common repower for cruising pontoons, $11,000–$18,000 CAD for the motor alone. Performance-leaning pontoons and tritoons often move to Pro XS V8 4.6L 175 HP with the Mercury Boost option, 25 extra horsepower on demand for 4–6 seconds, at $18,000–$22,000 CAD plus the ~$1,200–$1,800 CAD Boost premium.',
      ...
      },
      {
        ...
        paragraphs: [
          'You drive south to Gores Landing, 40 minutes, and pick up. We do not ship Mercury motors and we do not deliver to Bridgenorth or to Chemong Lake cottages. The motor is installed, propped, fuel-connected, controls run, and water-tested on Rice Lake before you arrive. Typical turnaround is 1–3 weeks once the motor lands.',
          'Financing runs 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC. Deposits are $200 for portable HP, $500 for mid-range, $1,000 for big-block, Pro XS, or special-order Verado. For trade-ins, we email a CAD figure within one business day. For ranges by HP, see our Mercury repower cost guide.',
        ],
      },
    ],
    faqs: [
  ...
  // 8. Lindsay
  {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'This is one of the longer drives in our regular service area, and we are direct about that. Lindsay customers pick us because they want a Mercury Platinum Dealer with a real water test and a shop that has been rigging motors since 1965. An hour each way is reasonable when one team handles the whole job (motor, controls, cables, prop setup, and a verified on-water run) and there is no third party in the middle.',
        ],
      },
      {
        heading: 'What Mercury motors do Lindsay boaters typically repower with?',
        paragraphs: [
          'Lindsay-area customers run a wide spread across the Kawartha chain. On Sturgeon, Scugog, and Cameron, cruising pontoons and runabouts most often repower with Mercury FourStroke 90–150 HP, $11,000–$18,000 CAD for the motor alone. Bigger fiberglass and performance pontoons commonly step up to Pro XS V8 4.6L 175–225 HP at $18,000–$28,000 CAD. The Mercury Boost option, 25 extra horsepower on demand for 4–6 seconds, is a popular add-on on heavier pontoons, $1,200–$1,800 CAD over the base motor.',
    ...
    faqs: [
      ...
      { question: 'What HP Mercury is common for Sturgeon, Scugog, and Cameron Lake boats?', answer: 'Mid-range Mercury FourStroke 90–150 HP is common on cruising pontoons and runabouts. Pro XS V8 4.6L 175–225 HP shows up on bigger fiberglass and performance pontoons.' },
      { question: 'Can I finance a Mercury repower if I live in Lindsay?', answer: 'Yes. Financing runs 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC. We finalize numbers at quote.' },
  ...
  // 9. Bobcaygeon
  {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'That is a real drive, and we are not going to dress it up. Bobcaygeon customers come to us because they want a Mercury Platinum Dealer, a water test on a real lake, and a shop where the same techs who built the quote are the ones who rig and run the boat off the dock. Bobcaygeon is destination boating country, the boat is central to the cottage week, and that usually makes the trip easier to justify.',
        ],
      },
      {
        heading: 'What Mercury motors do Bobcaygeon boaters typically repower with?',
        paragraphs: [
          'The Pigeon-Sturgeon-Buckhorn corridor sees a lot of mid-to-large repowers. Cruising pontoons and family runabouts typically land at Mercury FourStroke 90–150 HP, $11,000–$18,000 CAD for the motor alone. Performance pontoons and bigger fiberglass commonly move to Pro XS V8 4.6L 175–250 HP, $18,000–$30,000 CAD, often with the Mercury Boost option, 25 extra horsepower on demand for 4–6 seconds, at roughly $1,200–$1,800 CAD on top.',
    ...
    faqs: [
      ...
      { question: 'What HP Mercury is common for Pigeon and Sturgeon Lake boats?', answer: 'Cruising boats run mid-range FourStroke 90–150 HP. Performance pontoons and bigger fiberglass run Pro XS V8 4.6L 175–250 HP, often with the Boost option for 25 extra horsepower on demand.' },
      { question: 'Why drive 75 minutes for a repower?', answer: 'Because we are a Mercury Platinum Dealer, selling Mercury since 1965, every motor gets water-tested on Rice Lake before pickup, and the same techs who write your quote are the ones who do the install.' },
  ...
  // 10. Buckhorn
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'The northern Kawartha mix skews toward family boats and cottage pontoons. Mercury FourStroke 90–150 HP is the most common repower for cruising pontoons and runabouts at $11,000–$18,000 CAD for the motor alone. Performance pontoons and bigger fiberglass move to Pro XS V8 4.6L 175–225 HP at $18,000–$28,000 CAD, often with the Mercury Boost option, 25 extra horsepower on demand for 4–6 seconds, at $1,200–$1,800 CAD on top of the base motor.',
      ...
      },
      {
        ...
        paragraphs: [
          'You drive south to Gores Landing, about 70 minutes, and pick up. We do not ship Mercury motors and we do not deliver to Buckhorn or to cottages on Lower Buckhorn Lake. Many Buckhorn customers drop the boat with us at the quote visit and return for pickup after the rigging and water test. Typical turnaround is 1–3 weeks once the motor lands. Winter bookings for spring launch, January through April, are the busiest window.',
          'Financing runs 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC. Deposits are $200 for portable HP, $500 for mid-range, $1,000 for big-block, Pro XS, or special-order Verado. For ranges by HP, see our Mercury repower cost guide. For the nearest companion read, our Bobcaygeon page covers the same northern Kawartha corridor from a different angle.',
        ],
      },
    ],
    faqs: [
      ...
      { question: 'What HP Mercury is common for Buckhorn Lake boats?', answer: 'Pontoons and family runabouts typically repower with Mercury FourStroke 90–150 HP. Performance pontoons and bigger fiberglass run Pro XS V8 4.6L 175–225 HP, often with the Boost option for 25 extra horsepower on demand.' },
      { question: 'How long is the wait for a Mercury repower from Buckhorn?', answer: 'Typical turnaround is 1–3 weeks once the motor arrives. Winter bookings for spring launch are the busiest window, most Buckhorn customers book January through April.' },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'For pontoon owners running loaded weekends, Pro XS V8 4.6L 175 HP with the Mercury Boost option, 25 extra horsepower on demand for 4–6 seconds, is the most-asked-about upgrade. Boost costs roughly $1,200–$1,800 CAD on top of the base motor. Rice Lake can be shallow, weedy, and busy in summer, so we prop for that.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'Same for everyone, in-county or out. We do not ship Mercury motors and we do not deliver, not within Cobourg, not to a Port Hope address, not even within Gores Landing. The motor is rigged, propped, fuel-connected, controls run, and water-tested on Rice Lake before you arrive. You drive to Gores Landing and pick up. Typical turnaround is 1–3 weeks once the motor lands.',
          'Financing runs 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC. Deposits are $200 for portable HP, $500 for mid-range, $1,000 for big-block, Pro XS, or special-order Verado. For trade-ins, fill the form and we email a CAD figure within one business day. For full HP ranges, see our Mercury repower cost guide.',
        ],
      },
    ],
    faqs: [
      ...
      { question: 'Can Northumberland County customers finance a repower?', answer: 'Yes. Financing runs 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC. We finalize numbers at quote.' },
    ],
    visitExtra:
      "We're the repower side of Harris Boat Works, a family marina in Gores Landing serving boaters since 1947. The same techs who write your quote are the ones who rig and water-test the motor on Rice Lake.",
    related: [
