...
import seoPageMetadata from '../seoPageMetadata.json';

// Titles and meta descriptions are owned by src/data/seoPageMetadata.json so the
// React page, the prerenderer and the SEO audit all read one value per route.
const FAMILY_SEO: Record<string, { title: string; description: string }> =
  seoPageMetadata.mercuryFamilies;
...
export const PORTABLE_9_20HP: LandingConfig = {
  ...
  metaTitle: FAMILY_SEO['/mercury/portable-9-20hp'].title,
  metaDescription: FAMILY_SEO['/mercury/portable-9-20hp'].description,
...
export const MID_RANGE_40_60HP: LandingConfig = {
  ...
  metaTitle: FAMILY_SEO['/mercury/mid-range-40-60hp'].title,
  metaDescription: FAMILY_SEO['/mercury/mid-range-40-60hp'].description,
...
export const MID_POWER_90_115HP: LandingConfig = {
  ...
  metaTitle: FAMILY_SEO['/mercury/mid-power-90-115hp'].title,
  metaDescription: FAMILY_SEO['/mercury/mid-power-90-115hp'].description,
...
export const HP_150: LandingConfig = {
  slug: '/mercury/150-hp',
  metaTitle: FAMILY_SEO['/mercury/150-hp'].title,
  metaDescription: FAMILY_SEO['/mercury/150-hp'].description,
  ...
  faq: [
    ...
    { question: "What's included in the price?", answer: 'The price includes the outboard engine and standard factory warranty. Rigging and installation are additional. We can generally arrange boat pickup. Ask us about availability for your boat and location. HBW does not deliver boats, ship motors, offer mobile, dockside, or on-site service, recommend transport providers, or quote third-party transport.' },
...
export const PRO_XS_115: LandingConfig = {
  ...
  metaTitle: FAMILY_SEO['/mercury/115-pro-xs'].title,
  metaDescription: FAMILY_SEO['/mercury/115-pro-xs'].description,
