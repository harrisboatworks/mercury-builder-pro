...
export const faqCategories: FAQCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: '<strong>Two clocks, and only one of them costs you your summer.</strong><br><br><strong>Your boat is with us: 2 to 5 days.</strong> Drop-off to pickup. Old motor off, new Mercury rigged, controls and prop sorted, and a real water test on Rice Lake before you take it home.<br><br><strong>Getting the motor.</strong> We stock the most popular models. If yours is on the shelf, you book a drop-off date and that\'s the whole story. If it has to be ordered, the wait depends on the model and what Mercury has available — we\'ll give you a real date when we place the order, and we\'ll coordinate your drop-off around it.<br><br><strong>You keep your boat while we wait.</strong> We don\'t take it in until your motor is here on the floor. So even on a special order, you\'re only off the water for those 2 to 5 days.'
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'No, Harris Boat Works does not ship Mercury outboard motors. Motor purchases are pickup only at our Gores Landing, Ontario location on Rice Lake (5369 Harris Boat Works Rd, Gores Landing, ON K0K 2E0). The buyer must pick up in person with valid government photo ID — we cannot release a motor to a courier, shipping company, or any other third party. This is a deliberate choice: every motor we sell gets a personal walk-through with the customer covering controls, break-in procedure, warranty registration, and any boat-specific rigging questions. That hand-off is part of why we hold Mercury Premier Dealer status. We serve customers within roughly a 200 km radius, Toronto, Peterborough, Kawartha Lakes, Cobourg, Belleville, Kingston, and the entire GTA, all within easy driving distance.'
      },
      {
        question: 'Can I send a courier to pick up my motor?',
        answer: 'No. Motor purchases are pickup only at Gores Landing, Ontario. The buyer must pick up in person with valid government photo ID. We cannot release a motor to a courier, shipping company, or any other third party. Pickup is by appointment at 5369 Harris Boat Works Rd, Gores Landing, ON K0K 2E0 — call <a href="tel:9053422153" class="text-primary hover:underline">905-342-2153</a> to schedule.'
      },
      {
        question: 'How do I pick up my Mercury outboard from Harris Boat Works?',
        answer: 'Pickup takes about 20–30 minutes and is by appointment only. After your deposit is paid and your motor is ready, we book a pickup time that works for you. At pickup, please bring: (1) a valid government-issued photo ID matching the name on the purchase order, (2) your purchase order or quote reference number, and (3) a vehicle and trailer (or appropriate transport) suitable for the motor size. The motor is released only to the buyer in person — we cannot release it to a courier, shipping company, or any other third party. Our address is 5369 Harris Boat Works Rd, Gores Landing, ON K0K 2E0, about 35 minutes from Peterborough and 90 minutes from Toronto. Call <a href="tel:9053422153" class="text-primary hover:underline">905-342-2153</a> to schedule.'
      }
    ]
  },
  {
