...
export const locations: LocationPageData[] = [
  ...
  },
  {
    ...
    title: 'Mercury Service and Repower Near Peterborough',
    metaDescription:
    ...
    driveRoute: 'Highway 28 South → County Road 9 East → Gores Landing',
    intro:
      'Harris Boat Works is a Mercury Premier Dealer and Mercury Certified Repower Centre in Gores Landing, about 35 minutes south of Peterborough. Customers bring their own boats for scheduled Mercury and MerCruiser work. HBW does not provide or arrange transport.',
    localContext: [
      'Usual route: Highway 28 South, then County Road 9 east toward Gores Landing',
      'Customer drop-off and pickup only at 5369 Harris Boat Works Rd',
    ...
    popularHpRanges: [],
    whyChooseUs: [
      'Mercury Premier Dealer and Mercury Certified Repower Centre',
      '1,746 total work orders recorded in 2025',
      "Ontario's largest Mercury and MerCruiser parts inventory",
      'Current bare-motor prices in CAD and an installed starting quote online',
      'Completed repowers are water-tested on Rice Lake before pickup',
    ],
    recommendedLinks: [
      QUOTE_LINK,
    ...
    faqs: [
      ...
      { question: 'Can Peterborough customers get a Mercury quote before driving?', answer: 'Yes. The pricing reference shows current bare-motor selling prices in CAD. The quote builder provides an installed starting point. HBW confirms the final price and written scope.' },
      { question: 'Does HBW deliver to Peterborough?', answer: 'No. Customers bring their boats to Gores Landing and return for pickup. HBW does not provide or arrange transport.' },
