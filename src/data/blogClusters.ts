...
export const blogClusters: BlogCluster[] = [
  ...
  },
  {
    ...
    spokes: [
      ...
      "mercury-60-hp-fourstroke-review-ontario",
...
export const blogClusterContexts: Record<string, string> = {
  ...
  "mercury-command-thrust-real-talk-bigfoot-pontoon-v-hull": "where Command Thrust helps and where it hurts",
  ...
  "mercury-60-hp-fourstroke-review-ontario": "60 HP FourStroke review",
