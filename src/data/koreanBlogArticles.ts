...
공식 FMZ 17 개장일 직후 봄철이 흔히 활발합니다. 해 뜨기 전후 2시간이 황금 시간대인 경우가 많습니다. 날짜와 한도는 당해 규정을 확인하세요.
...
---`,
    faqs: [
      ...
      { question: '전기 트롤링 모터만 달린 보트에도 PCOC가 필요한가요?', answer: '동력 레저 보트를 조종하려면 인정되는 조종 자격 증명이 필요합니다. PCOC가 가장 흔한 형태이며, Transport Canada는 일부 다른 증명도 인정합니다.' },
...
---`,
  ...
  },
  {
    ...
    image: '/lovable-uploads/blog-audit-2026-09/mercury-seonoegi-muge-ko.svg',
