...
1947 سے خاندانی کاروبار، 1965 سے Mercury ڈیلر، آپ کی کشتی کی سمجھ بوجھ رکھنے والی جگہ۔`
  },
  {
    ...
    faqs: [
      { question: 'کشتی کی winterization کیسے ہوتی ہے؟', answer: 'سب سے پہلے انجن اور تمام سسٹم سے پانی مکمل نکالا جاتا ہے۔ پھر فیول میں stabilizer ڈالا جاتا ہے، بیٹری کو کشتی میں ہی چھوڑ کر ڈسکنیکٹ کیا جاتا ہے، اور lower unit کا تیل تبدیل کیا جاتا ہے۔ آخر میں انجن کے اندرونی حصے پر fogging oil کا سپرے کیا جاتا ہے۔' },
