...
export const LOCATION_LONGFORM_EXTRAS: Record<string, LocationLongFormExtras> = {
  'port-hope': {
    quickAnswer:
      "Harris Boat Works is about 30 minutes north of Port Hope, in Gores Landing on the south shore of Rice Lake. We're a Mercury Premier Dealer, family-owned since 1947. We rig the motor at the shop, and the standard handoff includes a Rice Lake water test when safe seasonal conditions allow. Then you pick up at the shop. No shipping, no delivery. A full repower typically runs $11,000-$40,000 CAD. Build a quote at mercuryrepower.ca.",
  ...
  bewdley: {
    quickAnswer:
      "Harris Boat Works is about 15 minutes east of Bewdley, on the same Rice Lake your boat already runs. We're a Mercury Premier Dealer, family-owned since 1947. Motors are rigged at the shop, and the standard handoff includes a Rice Lake water test when safe seasonal conditions allow. Then you pick up in Gores Landing. No shipping. A full repower typically runs $11,000-$40,000 CAD. Build a quote at mercuryrepower.ca.",
    lastReviewed: '2026-05-24',
    whatWeSeeAtHBW:
  ...
  'gores-landing': {
    quickAnswer:
      "Harris Boat Works is the village marina in Gores Landing, at 5369 Harris Boat Works Rd on the south shore of Rice Lake. We're a Mercury Premier Dealer, family-owned since 1947. For locals the trip is a short drive or a walk. The standard handoff includes a Rice Lake water test when safe seasonal conditions allow. A full repower typically runs $11,000-$40,000 CAD.",
    lastReviewed: '2026-05-24',
    whatWeSeeAtHBW:
      'We have repowered boats for our Gores Landing neighbours for three generations. The conversation is short because we usually know the boat, and often the last motor we put on it. Local or not, the standard handoff still includes the same Rice Lake water test when safe seasonal conditions allow.',
  ...
  roseneath: {
    quickAnswer:
      "Harris Boat Works is about 15 minutes west of Roseneath, on the same Rice Lake your boat already runs. We're a Mercury Premier Dealer, family-owned since 1947. Motors are rigged at the shop, and the standard handoff includes a Rice Lake water test when safe seasonal conditions allow. Then you pick up in Gores Landing. No shipping. A full repower typically runs $11,000-$40,000 CAD. Build a quote at mercuryrepower.ca.",
    lastReviewed: '2026-05-24',
    whatWeSeeAtHBW:
  ...
  hastings: {
    quickAnswer:
      "Harris Boat Works is 25 to 30 minutes from Hastings, around Rice Lake to Gores Landing. We're a Mercury Premier Dealer, family-owned since 1947, and we work with a lot of Trent-Severn boaters. The standard handoff includes a Rice Lake water test when safe seasonal conditions allow. No shipping. A full repower typically runs $11,000-$40,000 CAD. Build a quote at mercuryrepower.ca.",
    lastReviewed: '2026-05-24',
    whatWeSeeAtHBW:
  ...
  lakefield: {
    quickAnswer:
      "Harris Boat Works is about 45 minutes south of Lakefield, in Gores Landing on Rice Lake. We're a Mercury Premier Dealer, family-owned since 1947, and we handle bigger Stony Lake hulls regularly. The standard handoff includes a Rice Lake water test when safe seasonal conditions allow. No shipping. A full repower typically runs $11,000-$40,000 CAD. Build a quote at mercuryrepower.ca.",
    lastReviewed: '2026-05-24',
    whatWeSeeAtHBW:
  ...
  bridgenorth: {
    quickAnswer:
      "Harris Boat Works is about 40 minutes south of Bridgenorth, in Gores Landing on Rice Lake. We're a Mercury Premier Dealer, family-owned since 1947, and Chemong Lake pontoons are a core part of our repower work. The standard handoff includes a Rice Lake water test when safe seasonal conditions allow. A full repower typically runs $11,000-$40,000 CAD. Build a quote at mercuryrepower.ca.",
    lastReviewed: '2026-05-24',
    whatWeSeeAtHBW:
  ...
  lindsay: {
    quickAnswer:
      "Harris Boat Works is about 60 minutes east of Lindsay, in Gores Landing on Rice Lake. We're a Mercury Premier Dealer, family-owned since 1947, serving boaters across Sturgeon, Scugog, and Cameron. The standard handoff includes a Rice Lake water test when safe seasonal conditions allow. No shipping. A full repower typically runs $11,000-$40,000 CAD. Build a quote at mercuryrepower.ca.",
    lastReviewed: '2026-05-24',
    whatWeSeeAtHBW:
  ...
  bobcaygeon: {
    quickAnswer:
      "Harris Boat Works is about 75 minutes south of Bobcaygeon, in Gores Landing on Rice Lake. We're a Mercury Premier Dealer, family-owned since 1947, serving the Pigeon, Sturgeon, and Buckhorn corridor. The standard handoff includes a Rice Lake water test when safe seasonal conditions allow. No shipping. A full repower typically runs $11,000-$40,000 CAD. Build a quote at mercuryrepower.ca.",
    lastReviewed: '2026-05-24',
    whatWeSeeAtHBW:
  ...
  buckhorn: {
    quickAnswer:
      "Harris Boat Works is about 70 minutes south of Buckhorn, in Gores Landing on Rice Lake. We're a Mercury Premier Dealer, family-owned since 1947, and we repower a lot of northern Kawartha cottage boats. The standard handoff includes a Rice Lake water test when safe seasonal conditions allow. No shipping. A full repower typically runs $11,000-$40,000 CAD. Build a quote at mercuryrepower.ca.",
    lastReviewed: '2026-05-24',
    whatWeSeeAtHBW:
  ...
  'northumberland-county': {
    quickAnswer:
      "Harris Boat Works is the Mercury Premier repower shop we run in Northumberland County, in Gores Landing on Rice Lake. We're a Mercury Premier Dealer, family-owned since 1947, and most of the county is within 30 minutes of our dock. The standard handoff includes a Rice Lake water test when safe seasonal conditions allow. A full repower typically runs $11,000-$40,000 CAD. Build a quote at mercuryrepower.ca.",
    lastReviewed: '2026-05-24',
    whatWeSeeAtHBW:
