    ...
    faqs: [
      {
        ...
        answer: 'Confirmez auprès de HBW la disponibilité du moteur, le câblage et le rendez-vous pour votre bateau. Il n\'y a pas de délai universel; seuls le devis écrit et l\'horaire confirmés font foi.'
      },
      {
...
Avant même de parler de technique, parlons carburant. La majorité des stations-service en Ontario vendent de l'essence contenant jusqu'à 10 % d'éthanol (E10). En été, ça passe. Laissez ce carburant vieillir dans le réservoir de votre bateau pendant cinq ou six mois d'hiver, et vous aurez un problème sérieux.
...
## Les étapes de l'hivernisation

Le détail exact varie selon le modèle Mercury et sa configuration. Les étapes suivantes couvrent les points communs à la plupart des moteurs hors-bord.
...
Pour la mise à l'eau au printemps, la fenêtre habituelle se situe entre la mi-avril et la fin mai selon la région. Si vous voulez être prêt dès le premier beau week-end de mai, l'hivernisation bien faite en automne est votre meilleur investissement.
...
---`,
    faqs: [
      ...
      },
      {
        ...
        answer: 'Oui. HBW offre l\'entreposage extérieur avec pellicule rétractable professionnelle, l\'entreposage extérieur non couvert et le service de pellicule rétractable seulement. Nous n\'offrons pas d\'entreposage intérieur ou chauffé.'
      }
    ],
    howToSteps: [
      ...
      { name: 'Lubrification interne (fogging)', text: 'La protection interne dépend du modèle et du numéro de série. Suivez la procédure du manuel Mercury correspondant; ne vaporisez pas d\'huile dans l\'admission ou les cylindres sur la seule base d\'un guide général.' },
      ...
      { name: 'Plan de batterie approuvé', text: 'Une batterie en bon état peut rester à bord seulement si elle est pleinement chargée, débranchée, sécurisée et autorisée par le plan d\'entreposage approuvé. Le manuel du modèle/numéro de série et le plan d\'entreposage approuvé font foi.' },
...
---`,
    faqs: [
      ...
      },
      {
        ...
        answer: 'Pour une location, une liste de vérification de sécurité dûment remplie peut constituer une preuve de compétence reconnue. HBW exige toutefois une CCEP valide pour chaque conducteur lors de la prise en charge.'
      },
      {
  ...
  },
  {
    ...
    image: '/lovable-uploads/blog-audit-2026-09/mercury-demarrage-verifications-fr.svg',
    imageAlt: 'Vérifications de base du démarrage : cordon et point neutre, batterie, carburant; arrêter en cas de doute et réserver un diagnostic.',
    author: 'Harris Boat Works',
...
Pas significativement. Les chiffres exacts varient avec la tarification de [Mercury Canada](https://www.mercurymarine.com/ca/en).
...
Mercury le présente ainsi. Confirmez le poids à sec publié pour le code de modèle commandé.
...
**Mercury Product Protection Platinum est un contrat de service prolongé, et non une prolongation de la garantie limitée Mercury. La couverture commence après la garantie limitée applicable et protège contre certaines défaillances mécaniques et électriques selon les modalités du contrat canadien. HBW vend normalement Platinum, le niveau de protection le plus complet de Mercury.**

- Jusqu'à **8 ans de couverture combinée**, garantie limitée applicable plus Product Protection
- Durées achetées de 1 à 5 ans, selon l'admissibilité et la couverture déjà incluse
- Couverture Platinum pour les pièces mécaniques et électriques admissibles
- Franchise de **50 $ par réclamation**
- Transfert possible à un acheteur subséquent à usage récréatif, sous réserve du processus Mercury

Les prix ci-dessous sont en dollars canadiens avant TVH et ont été vérifiés avec la fiche de prix HBW le 17 juillet 2026. Le modèle, le numéro de série, les heures et la couverture actuelle déterminent l'admissibilité et le prix final.

Consultez aussi la page maintenue des [prix Mercury Product Protection](/mercury-product-protection) et les [promotions Mercury en vigueur](/promotions).

---

## Ce qu'est Mercury Product Protection

Mercury définit Product Protection comme un contrat de service prolongé administré par Mercury Marine. La couverture Platinum commence après l'expiration de la garantie limitée Mercury applicable. Elle ne remplace pas l'entretien normal et ne transforme pas les pièces d'usure en pièces couvertes.

Mercury offre les niveaux Gold et Platinum. Gold vise les défaillances mécaniques. Platinum ajoute les défaillances électriques admissibles. **Platinum** est le niveau Product Protection vendu par HBW. **Premier** désigne le niveau de concessionnaire Mercury de Harris Boat Works, pas un plan Product Protection.

---

## Prix canadiens Platinum chez HBW

Chaque colonne correspond à la durée Product Protection achetée, et non au nombre total d'années de couverture.
...
Prix en CAD avant TVH. HBW confirme l'admissibilité et le prix final avec le numéro de série avant l'enregistrement.

---

## Admissibilité et durée disponible

Selon les modalités canadiennes actuelles :

1. Le contrat doit être acheté avant l'expiration de la garantie limitée Mercury applicable.
2. Un achat après la première année de garantie d'usine est assujetti à une surcharge.
3. Le produit doit dater de l'année civile courante ou des quatre années précédentes.
4. Le moteur doit avoir moins de 500 heures au moment de l'achat.
5. L'usage doit être récréatif. Les usages commerciaux, professionnels, gouvernementaux et liés au travail sont exclus.
6. La garantie limitée applicable et Product Protection ne peuvent pas dépasser 8 années combinées.

Une promotion active peut modifier la couverture incluse et, par conséquent, le nombre d'années Platinum à acheter. La fiche du numéro de série et les modalités de la promotion en vigueur ont priorité.

---

## Ce que Platinum couvre et exclut

Platinum couvre les composants mécaniques et électriques admissibles énumérés dans le contrat, notamment des éléments du bloc moteur, de l'embase, du système de carburant, du trim, de l'allumage, des commandes et de certains accessoires Mercury ou Quicksilver.

Les exclusions comprennent notamment :

- l'entretien normal et les consommables;
- l'usure normale et la corrosion;
- les accidents, l'abus, la négligence et la submersion;
- les modifications non approuvées;
- les usages commerciaux ou liés au travail;
- les composants non indiqués comme pièces couvertes.

Les prestations supplémentaires comprennent jusqu'à 200 $ par réclamation pour le remorquage sur l'eau et jusqu'à 200 $ pour le levage ou la sortie d'un bateau non remorquable de 26 pieds ou plus, selon les modalités du contrat.

---

## Transfert et réclamation

Le contrat peut être transféré à un acheteur subséquent à usage récréatif. La demande doit être soumise dans les **30 jours ouvrables** suivant l'achat et demeure assujettie aux documents, à l'inspection, aux frais et aux autres conditions de Mercury. Le transfert n'est donc pas automatique.
...
`,
    faqs: [
      { question: "Quelle est la différence entre Mercury Gold et Platinum?", answer: "Gold couvre les défaillances mécaniques admissibles. Platinum ajoute les défaillances électriques admissibles. HBW vend normalement Platinum. Premier est le niveau de concessionnaire Mercury de HBW, pas un niveau Product Protection." },
      { question: "Quand dois-je acheter Mercury Product Protection?", answer: "Avant l'expiration de la garantie limitée Mercury applicable. Les modalités canadiennes actuelles prévoient une surcharge après la première année de garantie d'usine. L'âge du moteur, les heures, l'usage et le numéro de série déterminent aussi l'admissibilité." },
      { question: "Mercury Product Protection est-elle transférable quand je vends mon bateau?", answer: "Oui, à un acheteur subséquent à usage récréatif si les conditions Mercury sont respectées. La demande doit être présentée dans les 30 jours ouvrables et peut exiger des documents, une inspection et des frais." },
      { question: "Quelle est la franchise?", answer: "50 $ par réclamation." },
      { question: "Mercury Product Protection couvre-t-elle l'entretien régulier?", answer: "Non. Les vidanges d'huile, turbines, bougies, anodes, filtres, hélices et autres consommables ou pièces d'usure ne sont pas couverts." },
      { question: "Où puis-je consulter les prix canadiens actuels?", answer: "La page /mercury-product-protection affiche la fiche de prix HBW par puissance et durée. Les prix sont en CAD avant TVH, et HBW confirme le prix final et l'admissibilité avec le numéro de série." },
    ],
  },
  {
...
Harris Boat Works : entreprise familiale depuis 1947, concessionnaire Mercury depuis 1965, et actuellement concessionnaire Mercury Premier. Gores Landing, Ontario, sur le lac Rice.`,
  ...
  },
  {
    ...
    image: '/lovable-uploads/blog-audit-2026-09/poids-hors-bord-mercury-fr.svg',
