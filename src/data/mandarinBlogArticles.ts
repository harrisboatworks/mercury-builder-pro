...
export const mandarinBlogArticles: BlogArticle[] = [
  ...
  // ============================================
  {
    ...
    content: `> **简短答案：** Harris Boat Works (HBW) 提供莱斯湖完整的室外收缩膜冬储服务。客户自送船 (HBW 不提供取送服务)，10 月底至 11 月送达，4 月初取回。船坞 12 月 1 日至 4 月 1 日停业，冬季不进行维修。价格因船长而异，请联系 HBW 获取精确报价。Mercury Platinum 经销商，三代莱斯湖游艇之家，自 1947 年。
...
[Mercury Platinum 经销商](https://www.mercurymarine.com/canada/en/) · 三代莱斯湖游艇之家 · 自 1947 年
...
item1Zh: [Mercury Marine](https://www.mercurymarine.com/canada/en/) Platinum 认证经销商
...
---`,
    faqs: [
      ...
      { question: '保修期多长？', answer: 'Mercury FourStroke标准保修3年。通过Platinum 经销商（如Harris Boat Works）购买，可享受额外保修优惠。' },
    ],
  },
  {
...
[Mercury Platinum 经销商](https://www.mercurymarine.com/canada/en/) · 莱斯湖 Gores Landing · 自 1947 年
...
---`,
  ...
  },
  {
    ...
    description: 'Harris Boat Works 是莱斯湖南岸三代家族船坞，自 1947 年。Mercury Platinum 认证。GTA 华人船主选择 HBW 的 5 个原因：距离、价格、Mercury 认证、传承、对华人客户的友好接待。',
    ...
    content: `> **简短答案：** Harris Boat Works (HBW) 是莱斯湖南岸的家族经营船坞,自 1947 年至今,已经传承三代。Mercury Platinum 认证经销商。距离多伦多 1-1.5 小时车程,服务价格比 GTA 同类船坞便宜 30-40%,Mercury 维修和冬储一体化。团队使用英语服务，欢迎带会英语的亲友同来或使用手机翻译软件——我们会耐心沟通、尽力配合 (info@harrisboatworks.ca)。HBW 客户自送自取,不提供取送服务。
...
[Mercury Platinum 经销商](https://www.mercurymarine.com/canada/en/) · 三代莱斯湖游艇之家 · 自 1947 年。我们卖船和修引擎已经 78 年了。这不是营销话术 ， 是数字。
...
Harris Boat Works 是安大略省 Rice Lake 的 [Mercury Marine](https://www.mercurymarine.com/canada/en/) Platinum 授权经销商，1947 年创办至今第三代经营。你可以在 [mercuryrepower.ca](https://www.mercuryrepower.ca) 查看透明的加元报价，不需要打电话，不需要谈判。
...
eyebrow: HBW Trust Points / HBW 信任要点
item1En: Mercury Marine Platinum certified dealer
item1Zh: Mercury Marine Platinum 认证经销商
item2En: Family marina since 1947
item2Zh: 自1947年家族经营的码头
item3En: Transparent CAD pricing, no haggling
item3Zh: 透明加元价格，无需讨价还价
...
- **完整保固**：通过Platinum 授权经销商购买，保固完整有效
...
A：安装新的 Mercury 机器后，Mercury 的原厂保固对新机适用。通过 HBW 这样的Platinum 授权经销商购买，保固完整有效。详细条款请在购买时确认。
...
`,
    faqs: [
      { question: 'Repower 之后保固怎么算？', answer: '通过 HBW Platinum 授权经销商购买的 Mercury 新机，享有完整 Mercury 原厂保固。保固期从安装完成日起算，详细条款请在购买时确认。' },
...
rightVariant: alternative
whenInDoubt: 不会英文又不熟船的华人买家, 强烈建议第一艘船买新的, 并找一家Platinum 经销商。带会英语的亲友同来或用翻译软件沟通即可——出问题时, 经销商等级和保修响应比省 $3,000 重要得多。
::
