...
<div class="hbw-language-note">
  <h3>关于语言的说明</h3>
  <p>本文以中文提供，因为我们希望让更多客户了解 Mercury 船外机的技术信息。我们努力以您的语言提供有用的内容。</p>
  <p>不过，我们必须诚实说明：我们的员工讲英语。如果您联系我们询价或服务，我们将以英语回复您。如果您愿意，可以使用 Google 翻译，或请家中懂双语的成员协助沟通。我们承诺为您提供最好的服务。</p>
</div>
...
四冲程 Mercury 请使用 Mercury 4-Stroke Marine Oil（FC-W 认证），**不能用汽车机油代替**。大多数四冲程 Mercury 全温度通用推荐 25W-40；在较低气温下使用、或追求更强加速（滑水、钓鱼比赛）时，Mercury 也认可 FC-W 10W-30。确切黏度以发动机罩标贴和用户手册为准，或致电我们 905-342-2153 确认。每 100 小时或每年一次（取较早者）。如果你只在 5 月到 10 月用船 20–30 小时，仍然建议每年换一次。
