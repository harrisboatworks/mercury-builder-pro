...
四冲程 Mercury 请使用 Mercury 4-Stroke Marine Oil（FC-W 认证），**不能用汽车机油代替**。正确的黏度（viscosity）取决于你的具体型号，请查阅发动机罩上的标贴和用户手册，或致电我们 905-342-2153 协助确认。每 100 小时或每年一次（取较早者）。如果你只在 5 月到 10 月用船 20–30 小时，仍然建议每年换一次。
