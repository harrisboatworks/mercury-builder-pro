...
export const mandarinBlogArticles: BlogArticle[] = [
  ...
  // ============================================
  {
    ...
    content: `> **简短答案：** Harris Boat Works (HBW) 只提供室外收缩膜冬储。客户自送自取，船长上限为 30 英尺。带拖车的公开价格为 21 英尺及以下 $33/英尺、22 至 28 英尺 $35/英尺；不带拖车则为 $36/英尺和 $39/英尺。价格可能变动，HST 和 shop supplies 另计，请以 [HBW 冬储价格页面](https://www.harrisboatworks.ca/winter-storage) 为准。

## 为什么 GTA 华人船主选择莱斯湖冬储

对可以自己拖船到 Gores Landing 的 GTA 船主来说，莱斯湖是一个实际的室外冬储选择。原因很简单：
...
1. **吊船上岸** ， 我们有自己的吊车和拖车，冬储船只上限为 30 英尺
...
公开价格按船长、是否带拖车和服务项目计算：

- **带拖车存放并含收缩膜：** 21 英尺及以下 $33/英尺；22 至 28 英尺 $35/英尺
- **不带拖车存放并含收缩膜：** 21 英尺及以下 $36/英尺；22 至 28 英尺 $39/英尺
- **仅做收缩膜：** 室内施工 $20/英尺；室外施工 $25/英尺。这里的“室内”指施工地点，不是室内冬储
- **四冲程舷外机冬化与保养：** 按马力从 $260.28 至 $495.01。40 至 60 HP 为 $337.84；75 至 115 HP 为 $425.71

以上为当前公开价，HST 和 shop supplies 另计，价格可能变动。请在预订前查看 [HBW 冬储价格页面](https://www.harrisboatworks.ca/winter-storage)。
...
item1Label: 带拖车室外冬储 (含收缩膜)
item1Value: $33 或 $35 / 英尺
item1Note: 21 英尺及以下 $33；22 至 28 英尺 $35。
item2Label: 不带拖车室外冬储 (含收缩膜)
item2Value: $36 或 $39 / 英尺
item2Note: 21 英尺及以下 $36；22 至 28 英尺 $39。HBW 不提供室内冬储。
item3Label: 仅做收缩膜 (Shrinkwrap Only)
item3Value: $20 或 $25 / 英尺
item3Note: 室内施工 $20；室外施工 $25。这不是室内存放价格。
item4Label: Mercury 引擎冬季保养
item4Value: $260.28 to $495.01
item4Note: 当前四冲程舷外机公开价，按马力计算。HST 和 shop supplies 另计。
item4Accent: true
item5Label: 春季检查 (Spring Check)
item5Value: 冬储客户免费
item5Note: 冬储客户包含春季检查；其他额外工作另计。
totalLabel: 最终价格
totalValue: 取决于船长、拖车和引擎
caveat: 所有价格为加元 (CAD)，仅限 Gores Landing 自送自取。价格可能变动，HST 和 shop supplies 另计。
::
...
秋季冬储位置有限，最好先提交服务申请，再按确认时间自送船只。若还需要春季工作，也可以在同一份申请里说明，避免开春再重新整理需求。
...
`,
    faqs: [
      ...
      { question: '冬储价格大概是多少？', answer: '带拖车并含收缩膜的公开价为：21 英尺及以下 $33/英尺，22 至 28 英尺 $35/英尺。不带拖车分别为 $36/英尺和 $39/英尺。船长上限 30 英尺，HST 和 shop supplies 另计，预订前请查看 harrisboatworks.ca/winter-storage。' },
...
3. **PCOC 操作员卡查验**：操作船的人必须出示实体 PCOC 卡，详情见 [证照办理指南](/blog/zh/gta-chinese-pcl-fishing-licence-guide)
...
`,
  ...
  // ============================================
  {
    ...
    title: 'GTA 华人 PCOC 操作员卡、PCL 船牌和安省钓鱼证指南',
    seoTitle: '华人 PCOC、PCL 船牌和安省钓鱼证攻略',
    description: '多伦多华人办理 PCOC 操作员卡、PCL 船只牌照与安省钓鱼证的完整流程：三者区别、有效期、证件携带规则、Rice Lake 钓鱼规定和 HBW 租船政策。',
...
- **加拿大驾照（G、G2、G1）不能代替 PCOC。** 这是两个完全不同的体系。
...
3. 通过后按课程机构流程领取实体 PCOC。Transport Canada 明确说明，纸质或电子 PCOC 副本不能代替实体卡；不要只把截图留在手机里。
...
- 当前申请、续期或转让可能收取费用，请在办理时查看 [Transport Canada Pleasure Craft Licensing](https://tc.canada.ca/en/marine-transportation/vessel-licensing-registration/apply-manage-vessel-registration) 的当期费用
- PCL 有效期为 5 年；姓名、地址、电话、电子邮箱或船只资料变化后应在 30 天内更新
- 转手卖船时需要更新登记
- 这一项不是考试，只是登记备案
...
step1Tip: 只选择 Transport Canada 认可的课程机构。PCOC 终身有效，但必须携带可接受的实体卡。
step2Label: 完成在线考试拿到 PCOC
step2Question: 考试通过后是否已经收到并随身携带实体 PCOC?
step2Tip: Transport Canada 说明纸质或电子 PCOC 副本不被接受。遗失时应向原课程机构申请补卡。
step3Label: 船只登记号 (Pleasure Craft Licence)
step3Question: 你的船是否超过 10 HP, 已向 Transport Canada 注册并贴号?
step3Tip: 当前 PCL 有效期为 5 年，办理可能收费。号码必须贴在船头两侧，字高至少 7.5 cm。
...
escalationBody: HBW 团队使用英语服务。可先查看本文的政府链接；维修需求请通过 hbw.wiki/service 提交。
::
...
- **65 岁及以上的安省或加拿大居民**：不需要购买 Outdoors Card 或钓鱼证，但钓鱼时必须携带显示姓名和出生日期的加拿大政府证件。
- **18 岁以下的安省或加拿大居民**：同样可用显示姓名和出生日期的加拿大政府证件作为钓鱼证。非加拿大居民未成年人适用不同规则，请查 Ontario.ca。
...
1. **"我有 G 牌就能开船。"** 错。安省驾照不能代替 PCOC，两个完全不同的体系。
...
4. **"我在中国有船证，到加拿大一定可以用。"** 不要自行假设。访加人员可接受的能力证明取决于证件和停留情况，请按 Transport Canada 的 proof of competency 规则核对。
5. **"到 HBW 租船只签安全清单就够了。"** 不够。联邦规则允许检查清单作为租期内的证明，但 HBW 要求每位操作员持有效的实体 PCOC。

---

## 六、罚款与风险

被检查时拿不出 PCOC 或其他有效能力证明、Pleasure Craft Licence 或安省钓鱼证，可能被开告票，严重情况下还可能没收渔获。具体金额请参考 [Transport Canada](https://tc.canada.ca/en/marine-transportation/preparing-operate-your-vessel/pleasure-craft-operator-card-pcoc) 和 [Ontario MNRF](https://www.ontario.ca/page/fishing-licence) 的官方信息。
...
- **租船时的 PCOC 检查**：HBW 会在出租前查验每位操作员的实体 PCOC。安全清单仍要完成，但不替代 HBW 的公司要求。
...
1. **先办 PCOC 操作员卡**：通过 Transport Canada 认可的课程机构学习和考试；卡终身有效。
2. **如果有船，办 Pleasure Craft Licence（PCL 船只登记号）**：在线申请，当前有效期 5 年，办理前核对费用。
...
`,
    faqs: [
      { question: '我有安省 G 牌驾照，是不是就不用考 PCOC 了？', answer: '不行。安省汽车驾照和 PCOC 是两个完全不同的体系。操作动力休闲船需要符合 Transport Canada 的 proof of competency 规则，G 牌不能代替 PCOC。' },
      { question: 'PCOC 操作员卡需要每年更新吗？', answer: '不需要。PCOC 终身有效，但操作时必须携带可接受的实体卡。Transport Canada 明确说明纸质或电子 PCOC 副本不被接受；遗失时应向原课程机构申请补卡。' },
      { question: '加拿大 PCOC 在中国能用吗？外国船证在加拿大能用吗？', answer: '加拿大 PCOC 是否被其他国家接受取决于当地规则。访加人员可接受的外国能力证明也有特定条件，请查看 Transport Canada 当前的 proof of competency 说明，不要自行假设。' },
      { question: '14 岁的孩子能自己开船吗？', answer: '加拿大对未成年人操作动力船有马力限制：12 岁以下在无人直接监督时最多 10 HP，12 至 15 岁在无人直接监督时最多 40 HP，16 岁以下不得操作个人水上摩托。仍需携带有效能力证明。' },
      { question: '我从 HBW 租船，需要自己带 PCOC 吗？', answer: '需要。HBW 的公司政策要求每位操作员在租船前持有效的实体 PCOC。纸质或电子 PCOC 副本不被 Transport Canada 接受，租船安全清单也不替代 HBW 的公司要求。' },
...
`,
...

  {
    ...
    description: '多伦多华人第一次到 Rice Lake 租船钓鱼的完整指南：HBW 要求每位操作员持有效 PCOC、当天到达流程、安全简报、安省钓鱼证（与船证分开）以及从 GTA 的驾车路线。',
    ...
    content: `> **简短答案：** 多伦多出发到 Rice Lake 约 90 分钟车程。加拿大交通部允许已完成的 Rental Boat Safety Checklist 在租期内作为法定能力证明，但 **HBW 的公司政策更严格：每位要操作租船的人都必须在租船前持有有效的实体 PCOC**。此外，请带政府签发的带照片证件、押金用信用卡，以及有效的安省钓鱼证（如果要钓鱼）。出发前请核对 [HBW 租船页面](https://www.harrisboatworks.ca/rentals) 的当前要求。
...
2. **安全简报和租船检查清单** ——HBW 工作人员会讲解船只控制、油门、急救设备位置、救生衣穿戴、紧急联系方式和允许航行的水域。检查清单必须完成，但在 HBW 它不代替公司要求的 PCOC。
...
加拿大交通部的全国规则允许已完成的《Rental Boat Safety Checklist》在该次租期内作为能力证明。但租船公司可以制定更严格的资格要求。

**HBW 要求每位可能操作租船的人持有有效的实体 PCOC。** 纸质或电子 PCOC 副本不符合 Transport Canada 对 PCOC 的要求。安全简报和检查清单仍然要完成，但不能代替 HBW 的 PCOC 要求。请在出发前查看 [HBW 租船页面](https://www.harrisboatworks.ca/rentals)，不要到现场才发现证件不符合要求。PCOC 终身有效；详见我们的 [PCOC、PCL、钓鱼证区别](/blog/zh/pcoc-pcl-fishing-licence-difference-ontario) 完整对比。
...
在 HBW 必须有。加拿大交通部允许租船检查清单作为租期内的法定能力证明，但 HBW 的公司政策要求每位操作员持有效的实体 PCOC。安全清单仍会完成，但不代替 PCOC。
...
`,
    faqs: [
      { question: 'Rice Lake 租船 中文：必须有 PCOC 吗？', answer: '在 HBW 必须有。加拿大交通部允许租船检查清单作为租期内的法定能力证明，但 HBW 的公司政策要求每位操作员持有效的实体 PCOC。安全清单仍会完成，但不代替 PCOC。' },
...

  {
    ...
    description: '安省新手常把三个证件搞混：PCOC（船只操作员卡）、PCL（船只牌照，当前有效期 5 年）和安省钓鱼证（由 MNRF 管理）。三者对比表、HBW 租船政策和官方申请链接。',
    ...
    content: `> **简短答案：** 三个证件管的是完全不同的事。**PCOC**（Pleasure Craft Operator Card，船只操作员卡）是终身有效的操作能力证明。**PCL**（Pleasure Craft Licence，船只牌照）是船身上的注册号。**钓鱼证**完全独立，由安省自然资源与林业部（MNRF）管理。加拿大交通部允许已完成的 Rental Boat Safety Checklist 在租期内作为能力证明，但 HBW 的公司政策要求每位租船操作员持有效的实体 PCOC。
...
| 费用 | 考试及卡片费用视认可提供商而定 | 需要申请费；以 Transport Canada 当前费用为准 | Outdoors Card + Licence 视类型而定 |
| 有效期 | **终身** | 5 年（到期续期） | Outdoors Card 3 年，Licence 1 年 / 1 天 / 8 天等 |
...
| 在 HBW 短期租船是否必须 | **必须携带实体 PCOC** | 出租船由船主办理 | 钓鱼就要，不钓鱼就不用 |
...
- **有效期：** 终身，不需要续期。
- **携带：** 操作船只时必须带着实体 PCOC。Transport Canada 不接受纸质或电子 PCOC 副本。

> **租船说明：** 加拿大交通部允许已完成的《Rental Boat Safety Checklist》在租期内作为能力证明，但租船公司可以设更严格要求。HBW 要求每位租船操作员携带有效的实体 PCOC，并完成安全简报和检查清单。

## PCL：船只牌照（船身注册号）

- **谁必须有：** 配 10 HP（7.5 kW）以上引擎的休闲船船主。
- **是什么：** 一串字母+数字（例如 \`ON 12345 AB\`），按规定**必须用至少 7.5 cm 高的字母**贴在船头两侧。
- **怎么办：** 在 [Transport Canada 船只牌照及注册页面](https://tc.canada.ca/en/marine-transportation/vessel-licensing-registration/apply-manage-vessel-registration) 在线申请。需要申请费；金额和处理时间以当前官方页面为准。
- **有效期：** 5 年。
...
| 情况 | PCOC | PCL | 钓鱼证 |
|---|---|---|---|
| 在 HBW 租 Rice Lake 船一天并钓鱼 | **要携带实体 PCOC** | 不用（船是出租公司的） | **要** |
...
**"换了引擎，PCL 要重新申请吗？"** 通常是更新现有 PCL。请在 30 天内通过 Transport Canada 系统提交新的引擎或船只资料，并按当前页面确认是否收费。
...
PCOC 是常见的操作能力证明（人证，终身有效）。PCL 是船的识别号码（船证，当前有效期 5 年）。动力船操作员和 10 HP 以上的船通常分别需要对应文件。

**Q：PCL 中文是什么意思？**
PCL = Pleasure Craft Licence，中文译为"船只牌照"，是贴在船头两侧的识别号码。申请、续期或转让的当前费用以 Transport Canada 页面为准。

**Q：船只操作员卡（PCOC）中文考试有吗？**
视 Transport Canada 认可提供商而定。请直接查认可名单并联系提供商确认，**我们不能保证所有提供商都有中文版**。

**Q：短期租船一定要 PCOC 吗？**
根据加拿大交通部规则，完成的《Rental Boat Safety Checklist》可以在该次租期内作为能力证明。但租船公司可以设更严格要求；HBW 要求每位租船操作员持有效的实体 PCOC。

**Q：钓鱼证和船证可以一起办吗？**
不可以——两套完全独立的系统，不同政府机构管理。PCOC / PCL 由加拿大交通部管，钓鱼证由安省 MNRF 管。

**Q：换引擎后 PCL 一定要更新吗？**
要。引擎 HP、船主、联络资料或船只资料变化后应在 30 天内更新 PCL 信息；是否收费以 Transport Canada 当前页面为准。
...
`,
    faqs: [
      { question: '安省 船牌 中文 PCOC 和 PCL 有什么区别？', answer: 'PCOC 是常见的操作能力证明，属于操作员；PCL 是贴在船头两侧的船只识别号码，属于船。PCOC 终身有效，当前 PCL 有效期为 5 年。' },
      { question: 'PCL 中文是什么意思？', answer: 'PCL = Pleasure Craft Licence，中文可译为船只牌照，是贴在船头两侧的识别号码。办理时间和当前费用以 Transport Canada 页面为准。' },
      { question: '船只操作员卡（PCOC）中文考试有吗？', answer: '视 Transport Canada 认可提供商而定。请直接查认可名单并联系提供商确认，我们不能保证所有提供商都有中文版考试。' },
      { question: '短期租船一定要 PCOC 吗？', answer: '加拿大交通部允许完成的 Rental Boat Safety Checklist 在租期内作为能力证明。但租船公司可以设更严格要求；HBW 要求每位租船操作员持有效的实体 PCOC。' },
      { question: '钓鱼证和船证可以一起办吗？', answer: '不可以——两套独立系统。PCOC / PCL 由加拿大交通部管，钓鱼证由安省自然资源与林业部（MNRF）管。' },
      { question: '换引擎后 PCL 一定要更新吗？', answer: '要。引擎 HP、船主、联络资料或船只资料变化后应在 30 天内更新 PCL 信息；是否收费以 Transport Canada 当前页面为准。' },
