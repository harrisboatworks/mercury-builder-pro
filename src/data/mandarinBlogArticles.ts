...
安大略省擁有超過 25 萬個湖泊，是全世界淡水資源最豐富的地區之一。無論是家庭出遊、釣魚，還是單純在水上放鬆，擁有一艘船確實能改變你在加拿大的週末生活。

對很多華人新移民來說，買船聽起來像一件很陌生的事。其實流程並不複雜，只是有幾個環節需要提前了解。

---

## 你需要駕照嗎？

在加拿大操作任何有馬達的休閒船，你需要能證明自己具備基本水上安全知識的文件。最常見的是**Pleasure Craft Operator Card（PCOC，船隻操作員卡）**。

PCOC 的特點：

- 一次考試，終身有效（不需要續期）
- 可以線上完成課程與考試，大約幾個小時
- 取得 PCOC 之後，你就可以操作任何休閒馬達船

如果你的船有馬達超過 10 馬力（7.5 千瓦），船本身還需要一張**Pleasure Craft Licence（PCL，船隻牌照）**。2026 年 PCL 規則有更新，舊的終身牌照已經改為 5 年續期制，費用為 $24 加幣。買船之前，先確認賣家是否已經有有效的 PCL，或者你需要自己申請。
...
我們建議：第一年留約 15-20% 的船價作為意外維修基金。這聽起來保守，但確實是新船主常常忽略的部分。
...
- 沒有歷史問題
- 較貴
- 適合：預算寬裕、希望保固完整、不想處理潛在維修問題的買家

**買二手船**
- 更便宜
- 可能有未知的歷史問題
- 適合：預算有限、願意花時間做檢查的買家
- 強烈建議：成交前由 Mercury 認證的修理廠做購買前檢查

如果你買的是 3-7 年內的二手船，加上完整的服務記錄，這通常是性價比最高的選擇。如果是超過 10 年的船，價格雖然低，但維修成本可能會抵消省下來的錢。
...
- 主要釣魚物種有 walleye（黃鱸）、smallmouth bass（小嘴鱸）、muskie（梭子魚）
- 公共碼頭包括 Bewdley、Hastings、Roseneath、Gores Landing（HBW 所在地）
...
1. **先試一次。** 從 HBW 租一天船（Legend 船配 Mercury 馬達），帶家人朋友出遊一天，看看船上生活是否適合你。
2. **取得 PCOC。** 線上完成，幾個小時就能搞定。買船前後都用得到。
3. **訂出預算上限。** 包含船價、保險、年度維修、存放、燃油，這樣你才知道哪個價位適合自己。
...
**我可以線上看 Mercury 馬達價格嗎？**
可以。在 [mercuryrepower.ca](https://www.mercuryrepower.ca) 你可以建立完整的安裝報價，包括馬達、安裝、配件，全部加幣計價，大約 3 分鐘就能完成。

**HBW 有租船嗎？**
有。9 艘 Legend 船，配 Mercury 馬達，整個釣魚季開放。請在 [harrisboatworks.ca/rentals](https://www.harrisboatworks.ca/rentals) 預訂。

**HBW 銷售釣魚牌照嗎？**
不銷售。請在 ontario.ca/fishing 或當地零售商購買。

**買二手船一定要做購買前檢查嗎？**
強烈建議。一次檢查費用大約 $150-250 加幣，但可以避免你買到問題船（漏氣、馬達內部腐蝕、座艙板腐爛等）。

---

## 內部連結

- [Rice Lake 釣魚完整攻略：大多倫多華人釣友必讀](/blog/zh/rice-lake-fishing-guide-toronto-chinese)
- [大多倫多華人買 Mercury 船外機指南](/blog/zh/chinese-mercury-outboard-guide-toronto)
- [安省華人船主入門：PCOC、PCL、釣魚證一次說清楚](/blog/zh/ontario-chinese-boating-license-fishing-guide)

---

## 準備開始？

在 [mercuryrepower.ca](https://www.mercuryrepower.ca) 建立你的 Mercury 馬達報價，或撥打 **905-342-2153** 與我們聯絡。
...
Rice Lake 是大多倫多最近的釣魚湖之一，距離多倫多市區約 80-90 分鐘車程。主要物種包括 walleye（黃鱸）、smallmouth bass（小嘴鱸）和 muskie（梭子魚）。需要安大略省釣魚牌照（Outdoor Card + Fishing Licence）。我們建議從 HBW 在 Gores Landing 的公共碼頭出發，那裡有 2 線水泥碼頭、停車位、洗手間和燃油服務。
...
Rice Lake 是大多倫多釣友的近距離選擇。從多倫多開車：
...
對於住在士嘉堡、烈治文山、北約克、密西沙加的華人釣友，這個距離既能享受真正的內陸湖體驗，又不會佔用整個週末。
...
Walleye 在安大略省漁業管理區 17（FMZ 17）有特定的尺寸限制（slot limit）。在留魚前，請查閱當前的安大略釣魚規定摘要。

### Smallmouth Bass（小嘴鱸）

晚春到初夏的主要釣魚對象。在岩石結構、水草邊緣特別活躍。可以用 jig、軟蟲、頂水餌等多種方式。
...
- 在 ontario.ca/fishing 線上購買
- HBW 不銷售釣魚證

**操作船需要**
- Pleasure Craft Operator Card（PCOC）：船主必備
- Pleasure Craft Licence（PCL）：船馬力 10HP 以上需要
...
對大多數多倫多華人釣友來說，**Gores Landing 是最方便的選擇**——設備齊全、容易找、有 HBW 工作人員可以協助。

---

## 釣魚船配備建議

如果你計劃在 Rice Lake 認真釣魚，理想配備是：

**主馬達：** Mercury 60-115 HP FourStroke（船 16-19 英尺鋁船）
**Trolling 馬達：** Mercury 9.9 ProKicker（拖釣專用）
**電子設備：** Chartplotter（顯示湖底結構，包括沉沒鐵路位置）
**安全配備：** 每人一件救生衣、信號哨、錨繩、備用槳

ProKicker 的特點是低速大扭矩，在 1-2 mph 拖釣速度下穩定運作，這正是主馬達做不到的。我們強烈建議認真釣 walleye 的客戶配備 ProKicker。
...
19 世紀有一條鐵路橫穿 Rice Lake 中段，已經淹沒在水下約 4 英尺深。它已經損壞了超過一個世紀的船底馬達。
...
是的，正常交通狀況下。週末早上比較順暢；週末下午回程可能會塞 30-60 分鐘。

**Rice Lake 適合家庭釣魚嗎？**
非常適合。湖水較淺、不會太冷、不會浪太大。是 GTA 家庭學習釣魚的理想湖泊。

**我可以在 HBW 租一艘釣魚船嗎？**
可以。9 艘 Legend 船，配 Mercury 馬達。請在 [harrisboatworks.ca/rentals](https://www.harrisboatworks.ca/rentals) 預訂。
...
**Rice Lake 周邊有餐廳嗎？**
Gores Landing 碼頭附近有 The Captain's Table。Cobourg 和 Bewdley 也有更多選擇。
...
- [大多倫多華人買 Mercury 船外機指南](/blog/zh/chinese-mercury-outboard-guide-toronto)
- [多倫多到 Rice Lake 一日釣魚遊完整指南](/blog/zh/toronto-rice-lake-one-day-fishing-trip-zh)
- [安省華人船主入門：PCOC、PCL、釣魚證](/blog/zh/ontario-chinese-boating-license-fishing-guide)

---

## 準備出發？

如果你需要 Mercury 馬達或維修，請在 [mercuryrepower.ca](https://www.mercuryrepower.ca) 建立報價，或撥打 **905-342-2153** 與我們聯絡。
...
安大略省的冬季不給你機會後悔。一台沒有做冬季保養的舷外機，殘留水分結冰後可能造成缸體破裂、冷卻系統損壞、管路爆裂, 修復費用可能遠超過保養成本的數十倍。正確的冬季保養（Winterization）應在**十月中旬至十一月初**完成，建議在感恩節後、冰期前進行。
...
安大略省氣溫可降至零下30度以下。舷外機內部的水分, 冷卻系統、管路、缸體, 一旦結冰就會膨脹。金屬和玻璃纖維承受不了這種壓力。

常見的凍裂損傷包括：
- 缸體裂縫
- 冷卻水道破損
- 機油冷卻器損壞
- 下齒輪箱（Lower Unit）密封失效

這類損傷通常需要大修，而不是簡單更換零件。把冬季保養看作年度投資，而不是可省略的項目。
...
如果你在安大略省的感恩節（十月第二個週一）之後不再使用船隻，那個長週末之後就是最佳保養窗口。不要等到第一場雪，到那時候你已經在跟天氣搶時間。
...
用淡水徹底沖洗發動機冷卻系統。如果你在淡水湖使用（Rice Lake、Kawarthas大多數湖區都是），殘留物較少，但仍應完整沖洗。確認所有排水口打開、水分完全排出。四衝程發動機有多個排水點，第一次做建議讓技師確認位置。

### 第二步：穩定燃油系統

在油箱中加入Mercury品牌燃油穩定劑（Fuel Stabilizer）。加完後讓發動機運行幾分鐘，讓穩定劑流遍整個燃油系統，包括化油器或噴油嘴。跳過這步的後果是：春天你會發現燃油已經變質、噴油嘴堵塞，啟動困難。

### 第三步：更換機油與機油濾芯

在發動機溫熱時排出舊機油。舊機油含有酸性物質，長時間靜置會腐蝕發動機內部金屬。更換為Mercury推薦的機油規格，同時換新機油濾芯。這個步驟不應省略，即使機油看起來「還好」。
...
排出下齒輪箱（Lower Unit）的機油，檢查舊機油的顏色和狀態。若機油呈乳白色或含有金屬屑，表示可能有水分滲入或密封件磨損，需要進一步檢查。正常機油應為暗褐色，無水分。注入新機油後確認無滲漏。

### 第六步：電池處理

拆下電池，充滿電後存放在室內乾燥、不會結冰的地方。不要把電池留在船上過冬, 寒冷會加速電池損耗，春天你可能發現電池已經報廢。冬季期間每月檢查一次電量或使用智慧型電池維護器（Battery Tender）維持電量。

### 第七步：外部清潔與保護

清潔發動機外殼，移除水垢、水草和任何污垢。噴塗防腐蝕劑於金屬部分（螺絲、連接處、外露金屬）。使用合適的發動機防護罩或帆布罩保護，避免雪水積聚和紫外線損傷。

---

## 自己做還是找專業技師？

許多有經驗的船主可以自行完成部分步驟。但以下情況**強烈建議**由Mercury認證技師進行：

- 第一次做冬季保養，不確定排水口位置
- 下齒輪箱機油有水分跡象（需要檢查密封件）
- 發動機已超過建議保養間隔
- 新購入的二手船，保養歷史不清楚
- Verado或較高馬力的Mercury, 複雜度更高

Harris Boat Works自1947年起為Rice Lake和Kawarthas地區的船主提供Mercury發動機完整冬季保養服務。作為Mercury Marine Platinum Dealer，我們的技師受過原廠訓練，使用Mercury原廠規格的材料。需要預約，請至hbw.wiki/service提交服務申請。
...
3. 確認螺旋槳無損傷，螺帽鎖緊
4. 缓慢啟動發動機，馬上檢查冷卻水出水
5. 讓發動機暖機，確認無異常噪音、無漏油、無警示燈
6. 在碼頭附近試航，確認操控正常後再出湖
...
**Q：冬季保養大概需要多少時間？**
A：由技師進行的完整保養，一般一至兩小時可完成。如果有額外問題（如密封件更換），時間會更長。建議提早預約，十月份技師行程通常很快排滿。

**Q：船存放在有暖氣的車庫，還需要做冬季保養嗎？**
A：需要。暖氣車庫可以防止外部結冰，但發動機內部的水分仍會造成腐蝕損傷，燃油仍會變質。冬季保養保護的是內部，不只是外部。

**Q：我忘記做冬季保養，春天能直接用嗎？**
A：先別急著啟動。讓技師先檢查有無凍裂跡象，再評估能否安全啟動。如果走運沒有凍裂，至少要補做機油更換和燃油系統清潔再使用。

**Q：Mercury的冬季保養要多久做一次？**
A：每年一次，每個冬季前。這不是依使用時數，而是依季節進行的預防性保養。

**Q：我的Mercury舷外機還在保固內，自己做冬季保養會影響保固嗎？**
A：使用非原廠材料或跳過建議步驟可能影響保固。建議使用Mercury原廠產品，並保留保養記錄。由認證技師進行更有保障。
...
- [換新發動機還是買新船？安大略省華人船主的現實判斷](/blog/zh/chinese-boat-repower-vs-new-boat-ontario)
...
115和150馬力是安大略省中型船主最常糾結的兩個選擇。**如果你的船在18英尺以下、通常一兩個人使用、主要釣魚，115馬力很可能足夠。如果船在18英尺以上、常載家人、需要拖曳水上玩具，150馬力的冗餘動力在未來幾年會讓你慶幸多花了那筆錢。**
...
Mercury FourStroke 115和150都屬於同一個可靠的四衝程系列，油耗合理、運轉安靜、保固條件相當。它們適合的船型有重疊，不像9.9馬力和200馬力之間那樣涇渭分明。這就是為什麼很多船主站在中間，不確定往哪邊走。
...
150馬力在**滿載情況下**的起步表現明顯優於115馬力。「滑行（Planing）」指船頭從水中抬起、船體在水面上滑行的狀態, 這是每次出湖最基本的舒適門檻。

如果你的船在115馬力下滿載需要全油門、很長時間才能滑行，這不只是速度問題，而是燃油效率、發動機負荷、使用壽命都受影響。

### 油耗：不是你想的那樣

很多人以為115馬力一定比150馬力省油。實際上取決於**工作轉速**：

- 如果115馬力需要開到80, 90%油門才能維持舒適速度，油耗並不低
- 150馬力在同樣速度下可能只需60, 70%油門，反而更省油
- **關鍵原則：發動機在60, 75%油門巡航比全油門運轉更省油、更靜音、壽命更長**

### 噪音

Mercury FourStroke系列兩款發動機在巡航速度下都安靜。150馬力在同樣速度下因轉速較低，有時甚至更安靜。
...
- 主要釣魚，通常只有1, 2人
- 不拖曳滑水板或水上充氣玩具
- 船的最大馬力標牌（Capacity Plate）在115, 150之間，且你不需要接近上限
- 預算考量較重

### 實際案例

**16英尺鋁合金釣魚船，主要2人使用：** 115馬力是合理的。船輕、人少、釣魚節奏慢，115馬力在這個使用情境下表現自然。
...
- 計畫這艘船用10年以上
- 船的Capacity Plate允許150馬力

### 實際案例

**20英尺玻璃鋼家庭遊船，常載一家四口：** 150馬力。滿載時輕鬆滑行，長途巡航更舒適，不需要推高轉速。

---

## 長期成本的真實計算

115和150馬力的購買價差，通常在$2,000至$3,500加元之間（依配置不同，請至mercuryrepower.ca查當前加幣報價）。

但請把這個數字放在更長的時間維度裡想：

- 如果未來5年你每年出湖40次，115馬力每次都要推高轉速才能讓船舒適滑行，燃油、機件磨損和那份不滿足感都是成本
- 150馬力多花的那幾千元，分攤到200次出湖，每次不到20元

選擇不夠用的馬力，往往比選擇足夠的馬力更貴。
...
真正適合115馬力的人，通常不需要問這個問題, 他們的船小、使用方式輕、答案很清楚。在115和150之間猶豫的人，多半是有家庭使用需求、偶爾載多人、想拖點東西, 那就是150馬力的使用情境。

---

## 如何查看當前報價

到 **[mercuryrepower.ca](https://www.mercuryrepower.ca)** 使用報價設定工具，可以直接比較115和150馬力不同軸長、操控配置的當前加幣價格。不需要打電話，不需要等報價，實際數字馬上看到。

---

## 常見問題

**Q：我的船Capacity Plate寫最大115馬力，可以裝150嗎？**
A：不可以，也不應該。最大馬力標牌是安全設計上限，超過可能影響船體穩定性並導致保險失效。請嚴格遵守Capacity Plate的標示。

**Q：115和150馬力的軸長選擇有什麼不同？**
A：軸長（Shaft Length）取決於船的Transom高度，與馬力選擇無關。請確認你的Transom高度後選擇Short（15"）、Long（20"）或Extra Long（25"）。

**Q：二手Mercury 115馬力和新的115馬力差距大嗎？**
A：差距在保固、磨損程度和保養歷史。一台有完整保養紀錄的二手Mercury可能很值得，但需要由技師評估。Harris Boat Works可協助評估現有發動機狀態。

**Q：我現在的舊發動機是90馬力，換115還是150？**
A：這取決於你的船型和使用方式。如果換發動機的同時想升級動力，建議在 hbw.wiki/service 提交服務申請，讓HBW技師評估你的船和使用需求。
...
**在115和150馬力之間拿不定主意？**
到 **[mercuryrepower.ca](https://www.mercuryrepower.ca)** 看兩款發動機的當前加幣報價，再聯絡HBW確認你的船體是否合適。
...
對大多倫多華人船主而言，Mercury 是內陸湖泊（如 Rice Lake、Kawartha Lakes）最普遍且可靠的船外機品牌。常見配置為主馬達 60-115 HP FourStroke + 9.9 ProKicker（用於拖釣）。馬力選擇需根據船體承重牌（capacity plate）。在 [mercuryrepower.ca](https://www.mercuryrepower.ca) 可線上查看完整安裝報價（加幣計價，約 3 分鐘）。
...
Mercury Marine 是全球最大的船外機製造商之一。在加拿大內陸湖泊的釣魚與休閒船界，Mercury 是最普遍的選擇，原因包括：

- **完整馬力範圍：** 從 2.5 HP 小型 portable 到 600 HP V12 Verado，幾乎所有需求都能滿足
- **加拿大保固完善：** 標準 3 年廠保，可加購延長保固至 5 年或 7 年
- **零件供應穩定：** 在加拿大有完整的經銷網絡，零件與服務隨時可得
- **白金經銷商支援：** Mercury Platinum 認證的修理廠具備完整保固處理與技術支援

對華人船主來說，Mercury 的好處還包括：許多 Mercury 經銷商有中文服務團隊，溝通較順暢。
...
對大多數華人家庭船主，**FourStroke 是最務實的選擇**。除非你有特殊需求，否則 Pro XS 與 Verado 的價格溢價不值得。
...
**1. 永遠不要超過船體承重牌（capacity plate）的最大馬力**

這不是建議，是法律。Transport Canada 規定每條船的承重牌標示最大允許馬力。超過會違法，保險也可能拒賠。

**2. 在承重牌範圍內，選擇實用最佳化的馬力**

- **載重多、家庭使用：** 偏向上限馬力
- **獨自釣魚、輕載：** 中段馬力即可
- **拖釣為主、不追求速度：** 中段馬力 + ProKicker

例如，16 英尺鋁船的承重牌通常標示 60-90 HP。如果你經常滿載家人去釣魚，選 90 HP；如果你獨釣或輕載，60 HP 已經足夠。

---

## 各應用場景的 Mercury 推薦配置

### Rice Lake / Kawartha Lakes 釣魚（最常見）

**16-18 英尺鋁船 + Mercury 60-90 HP FourStroke + 9.9 ProKicker**

主馬達負責移動，ProKicker 處理拖釣速度（1-2 mph）。這是 Rice Lake walleye 釣魚的標準配置。

### 家庭巡航與滑水

**18-20 英尺玻璃纖維船 + Mercury 115-150 HP FourStroke**

需要更高馬力以拉動滑水板與全載乘客。Command Thrust 變速箱在滿載時表現更好。

### Lake Ontario 鮭魚拖釣

**22-26 英尺深 V 船 + Mercury 200-300 HP V8 FourStroke + 15 HP ProKicker**

開放水域、強波浪、長距離拖釣，需要可靠的大馬力。9.9 ProKicker 不夠，需要 15 HP。
...
這是新買家常常忽略的細節。馬達軸長必須匹配船舷板高度：

- **短軸（15 英寸）：** 適合小型 portable 船、橡皮艇
- **長軸（20 英寸）：** 大多數常見休閒船
- **超長軸（25 英寸）：** 大型釣魚船、雙引擎設置、深 V 船

軸長選錯會導致：
- 軸太短：氣穴（空轉、推力不足）
- 軸太長：水阻過大、效率下降

買新船時，船廠通常會建議正確的軸長。買二手馬達放到不同船上時要特別小心。

---

## Command Thrust 是什麼？

部分 Mercury 馬達有 **Command Thrust** 版本（CT）。差別在於：

- 較大的螺旋槳
- 不同的變速箱齒比
- 更適合重載與低速航行
- 通常在 9.9-115 HP 馬達中提供
...
這是 HBW 與其他經銷商的關鍵差異——我們的價格透明，你不需要打電話才能知道實際成本。
...
- **新 Mercury 馬達銷售與安裝**
- **馬達更換（Repower）：** 把舊馬達換成新 Mercury
- **完整安裝服務：** 馬達、控制器、油門/換檔線、螺旋槳、試水
- **年度保養：** 春季啟用、秋季封存
- **保固服務：** Mercury 保固期內的維修

**重要：** 我們**只服務 Mercury 與 Mercruiser 馬達**。不接受 Yamaha、Honda、Suzuki 的維修。
...
**Mercury 馬達的標準保固是多久？**
3 年。可加購延長保固（MPP）至 5 或 7 年，視馬達型號而定。

**MPP（延長保固）必須在買新馬達時購買嗎？**
之前的規則是「購買後一年內」，但現在已經改了。新規則是「在標準 3 年保固到期前」都可以購買。

**Pro XS 比 FourStroke 好嗎？**
不是「好」或「壞」的問題，是適用場景不同。Pro XS 加速更快、頂速更高，但較吵、價格較貴。家庭娛樂選 FourStroke，比賽釣魚選 Pro XS。

**我可以買二手 Mercury 馬達嗎？**
可以，但建議先做購買前檢查。3-7 年內的二手 Mercury 通常性價比高。超過 10 年的，維修成本可能抵消省下的錢。
...
- [新移民安大略省買船完整指南](/blog/zh/new-immigrant-ontario-boat-buying-guide)
- [Rice Lake 釣魚完整攻略](/blog/zh/rice-lake-fishing-guide-toronto-chinese)
- [安省華人船主入門：PCOC、PCL、釣魚證](/blog/zh/ontario-chinese-boating-license-fishing-guide)
...
在 [mercuryrepower.ca](https://www.mercuryrepower.ca) 完整配置你的 Mercury 馬達，或撥打 **905-342-2153** 與我們聯絡。
...
在安大略省合法操作有馬達的船與釣魚，你需要三樣文件：**PCOC（船隻操作員卡）**、**PCL（船隻牌照，馬達 10HP 以上需要）**、**釣魚證（Outdoor Card + Fishing Licence）**。PCOC 是一次性考試終身有效；PCL 改為 5 年續期；釣魚證每年購買。三者都可以線上完成。
...
| **釣魚證** | 你可以在加拿大水域釣魚 | 每年 | ontario.ca/fishing |

簡單說：PCOC 是「人」的證明，PCL 是「船」的證明，釣魚證是「活動」的許可。

---

## PCOC 詳解

**Pleasure Craft Operator Card（PCOC，船隻操作員卡）** 是 Transport Canada 規定的強制證件。

**法律規定：**
任何在加拿大水域操作有馬達的休閒船（不論馬力多大）的人，必須持有 PCOC 或同等證明。
...
**法律規定：**
任何有 10 HP（7.5 千瓦）或以上馬達的休閒船，必須有 PCL。

**取得方式：**

1. 在 Transport Canada 官網申請（[www.tc.gc.ca](https://www.tc.gc.ca)）
2. 提供船的詳細資料（製造商、型號、船體編號、馬力）
3. 線上付費
4. 收到 PCL 號碼，貼在船兩側
...
**懲罰：**
無 PCL 操作有 10HP+ 馬達的船，可能罰款。海岸防衛、警察、Conservation Officer 可能會檢查。
...
- 可以選年費或日費
- **常見選項：**
  - Conservation Licence（限制較多，留魚量較少，價格較低）
...
- 每次釣魚前先查閱當前的 Ontario Fishing Regulations Summary

---

## 安全配備（法律規定）

不論你的船有沒有馬達，Transport Canada 規定的必備配備：
...
**我有中國的船舶駕照，可以在加拿大用嗎？**
不行。Transport Canada 不認可外國船舶駕照。你必須取得加拿大的 PCOC。
...
**我的釣魚證在哪些湖適用？**
適用於整個安大略省。不同湖泊有不同的 FMZ 規則（尺寸、限額、季節），但釣魚證本身全省通用。

**我可以使用線上版的釣魚證嗎？**
可以。在 [ontario.ca/fishing](https://www.ontario.ca/fishing) 購買後立即發給你電子版，可以截圖或下載到手機。

**未成年人需要釣魚證嗎？**
18 歲以下不需要。成年人陪同時，未成年人可以使用陪同成年人的釣魚證額度。

**HBW 銷售釣魚證嗎？**
不銷售。請至 ontario.ca/fishing 線上購買，或在當地零售商購買。
...
- [Rice Lake 釣魚完整攻略](/blog/zh/rice-lake-fishing-guide-toronto-chinese)
- [大多倫多華人買 Mercury 船外機指南](/blog/zh/chinese-mercury-outboard-guide-toronto)
- [為什麼 GTA 華人船主選擇 Harris Boat Works](/blog/zh/why-chinese-boaters-choose-harris-boat-works)
...
Rice Lake和Kawarthas釣魚船選馬力，不能只看最高速度。對釣友來說，**低速操控、起步能力、載重、穩定性、Trolling配置和保養便利性**，比多跑幾公里時速更重要。14至16英尺鋁船常見的研究區間是20至60馬力；更大的鋁船或多用途釣魚船可能會看75至115馬力。最終仍以船體Capacity Plate為準。
...
很多GTA華人釣友不是住在湖邊, 你是從Toronto、Markham、Richmond Hill、Scarborough或North York週末開車出發的。這代表每次出湖的時間都很寶貴：到了湖邊，你不想花半天處理啟動問題、馬力不足、螺旋槳不合或操控不順的狀況。

你想要的是：上船，啟動，走。

這就是為什麼「看起來夠用」和「真的夠用」之間的差距，對週末釣友特別重要。
...
|-------------|---------------------|----------|
| 小型鋁船、近岸釣魚 | 9.9, 20HP | 輕載、短距離、簡單維護 |
| 14, 16英尺鋁船 | 25, 60HP | Rice Lake / Kawarthas常見釣魚使用 |
| 16, 18英尺鋁船、多用途 | 60, 115HP | 更好的載重與起步能力 |
| Bass Boat / 競技風格 | Pro XS系列 | 重視Hole Shot、加速與操控 |
| Trolling / 輔助機 | 9.9 ProKicker或小馬力 | 長時間低速控制 |

*以上為參考區間，最終須以船體Capacity Plate上標示的最大馬力為準。*

---

## 兩個人測試結果不代表三個人實際使用

HBW技師經常提醒：「釣魚船最怕『看起來夠用，實際上不夠用』。」

兩個人、半箱油、沒有風、平靜水面的結果，不能代表三個釣友、滿載裝備、逆風回航的真實狀況。

**選馬力時，請用你最重的使用情境來想，不是最輕的。**

---

## Rice Lake使用情境

Rice Lake夏天週末熱鬧，你會遇到：其他船的波浪、變化的風向、淺水區和水草帶、碼頭進出的空間限制。在這些情況下，「低速控制」和「可靠啟動」的重要性不亞於最高速度。

Rice Lake不是需要你追求最高馬力的地方，但要避免明顯動力不足（Underpower）。鋁船或Pontoon在滿載後，低馬力會讓船難以有效進入滑行狀態，油耗也不一定比高馬力省。

Rice Lake屬於**FMZ 17**（漁業管理區17）。釣魚前請查當年度安大略省官方釣魚規則，以FMZ 17的最新規定為準。不要依賴社群群組截圖或舊文章作為規則判斷依據。

---

## Kawarthas使用情境

Kawarthas的湖區和Trent-Severn水道讓你不只待在一個地方釣魚, 你可能會跑一段水路、過水閘（Lock）、停靠不同的碼頭，也可能從釣魚模式轉成家庭巡航模式。這時候發動機的穩定性、低速操控和中段加速都很重要。

如果你計畫同一個行程從Rice Lake延伸到Trent-Severn水道，確認你的發動機型號可以在水閘限速內順暢低速運行。
...
| 起步、加速、釣魚性能反應 | Mercury Pro XS |
| 重載、Pontoon或需要更大推力 | Command Thrust配置 |
| 高級操控、靜音、大船體驗 | Verado |

對大多數GTA週末釣友來說，Mercury FourStroke是最自然的起點。Pro XS適合真的重視起步反應和釣魚性能的人, 不是因為它「比較好」，而是因為它為不同的使用優先順序設計。
...
**1. 螺旋槳比你想像的更重要**
同一台發動機，螺旋槳不同，起步和最高速度都會不同。買新發動機時，請讓HBW技師根據你的船型和使用方式確認螺旋槳選擇，而不是只用附件槳。

**2. 軸長不能靠猜**
Shaft Length（軸長）錯誤會影響性能、操控和安全。需要測量你的Transom高度後確認。

**3. 舊的操控配件不一定適合新發動機**
控制線、儀表、油路、電路都需要確認相容性。完整的Repower不只是換發動機本體，而是確認整個系統正確運作。

---

## 如何開始你的研究

1. 確認你的船長、Capacity Plate最大馬力限制、常載人數、主要釣法（岸釣、Trolling、Bass釣）
2. 記下你常去的湖區（Rice Lake、Kawarthas特定水道）
3. 到 **[mercuryrepower.ca](https://www.mercuryrepower.ca)** 看不同馬力區間的當前加幣報價
...
**Q：我的14英尺鋁船，兩個人釣魚，40馬力夠嗎？**
A：取決於船體Capacity Plate標示。如果最大馬力允許且你通常只帶基本裝備，40馬力對14英尺鋁船通常夠用。但如果你常帶第三個人或大量裝備，60馬力的餘裕更有價值。請在mercuryrepower.ca看報價後聯絡HBW確認。

**Q：Kawarthas有水閘限速，對發動機選擇有影響嗎？**
A：有間接影響。水閘速限要求低速運行，選擇低速操控良好的發動機配置（例如適當的螺旋槳）很重要。過水閘時通常不需要大馬力，但需要穩定的低速操控。

**Q：Rice Lake FMZ 17的規則在哪裡查？**
A：安大略省政府每年發布釣魚規則摘要（Ontario Fishing Regulations Summary），包含FMZ 17詳細規定。可在ontario.ca搜尋當年版本，也有繁體中文摘要版本可供參考。

**Q：我的舊發動機是二衝程，換成Mercury FourStroke值得嗎？**
A：現代Mercury FourStroke相比二衝程省油約30%至40%，且排放更環保、運轉更安靜。對週末釣友來說，油耗和噪音都是長期使用體驗。如果舊機已到壽命末期，換FourStroke通常是很值得的升級。至mercuryrepower.ca建立報價後，讓HBW評估你的具體情況。

---

## 內部連結

- [Mercury 9.9至20HP：釣魚小船、Kicker、Tiller中文指南](/blog/zh/mercury-9-9-20hp-chinese-kicker-tiller-guide)
...
Lake Simcoe的舷外機選擇不能只看「能不能跑」。你需要考慮**開放水面、風浪、低速Trolling、季節變化、載重**，以及你是否需要Kicker機或更可靠的主機。Lake Simcoe比Rice Lake水面更開闊，風起來時對動力和穩定性的要求更高。

釣魚規則方面，請直接查安大略省官方釣魚規則當年版本，不要依賴舊文章或社群截圖。
...
## 為什麼Lake Simcoe對GTA華人釣友很有吸引力

Lake Simcoe距離多倫多相對便利，有豐富的釣魚文化，四季都有不同的釣魚活動（包括冬季冰釣）。許多GTA華人釣友在Lake Simcoe有自己的釣點或固定的出湖路線。

但這也是一個對發動機有更多要求的水域, 比Rice Lake更大、更開闊、風浪的影響更明顯。週末下午湖中心的浪，跟你早晨出發時的平靜完全不同。

---

## Lake Simcoe買發動機的思考方式

很多Lake Simcoe釣友的船不是純休閒船。它可能是週末釣魚工具，也可能是家庭船，也可能春秋釣魚、夏天載家人。這種混合用途最容易買錯馬力。
...
| 使用方式 | 建議思考方向 |
|----------|-------------|
| 近岸釣魚、小鋁船 | 9.9, 25HP可能夠，但要看船長與載重 |
| 14, 16英尺鋁船 | 25, 60HP是常見研究區間 |
| 16, 18英尺釣魚船 | 60, 115HP常見，視船體和最大馬力限制 |
| 需要Trolling | 考慮Kicker或電動Trolling Motor搭配 |
| 重視開放水面性能 | Pro XS或合適的FourStroke高馬力 |

*以上為參考區間，最終須以船體Capacity Plate標示的最大馬力為準。*
...
| 對發動機的要求 | 可靠回航、低速控制、應對風浪 | 多用途、本地服務、Repower適配 |
| 華人釣友熟悉度 | 許多GTA釣友有固定使用習慣 | HBW本地經驗更深，服務在地 |
| 冰釣文化 | 非常活躍 | 相對較少 |

---

## Kicker機對Lake Simcoe釣友的價值

Kicker不是每個人都需要，但對在Lake Simcoe長時間出湖的釣友來說，它提供兩個重要功能：

1. **長時間低速控制**, Trolling時保持穩定速度，比調低主機油門更細膩
2. **安全備援**, 主機萬一在湖中心出問題，你有辦法把船開回去

在一個開闊水面、距離岸邊可能較遠的湖區，這份安心感是真實的。

選擇Kicker時要確認：軸長（Shaft Length）、轉向連動設置、燃油接頭、安裝架規格，以及與主機系統的相容性。不要只看馬力數字。
...
**請以當年度安大略省官方釣魚規則（Ontario Fishing Regulations Summary）為準。** 安大略省提供繁體中文釣魚規則摘要版，適合華人釣友作為入口，但最終仍以英文完整版的規定為準。

---

## GTA華人釣友的實際準備清單

1. **確認船型和Capacity Plate**, 最大馬力限制是所有選擇的前提
2. **決定是否需要Kicker**, 如果你在Lake Simcoe常出湖超過半天，Kicker值得認真考慮
3. **在mercuryrepower.ca看報價**, 可以比較不同馬力和配置的當前加幣價格
4. **確認釣魚證**, 有效的Ontario Fishing Licence是法律要求
...
**Q：Lake Simcoe和Rice Lake，同一台發動機適用嗎？**
A：技術上可能，但Lake Simcoe的開放水面對發動機的穩定性和回航能力要求更高。如果你同時在兩個湖使用，選擇時要以要求更高的情況（Lake Simcoe）為標準。

**Q：Lake Simcoe冬季冰釣需要什麼特別的發動機注意事項？**
A：冬季冰釣不使用發動機，但每年春季啟動前需要完整的季節性保養。確保你的Mercury在冬季正確越冬（Winterization），冰釣季過後春天才能順利啟動。

**Q：我從多倫多去Lake Simcoe，有什麼要注意的？**
A：行程前確認天氣預報（風速特別重要），帶足夠的燃油，確認手機有信號覆蓋或帶VHF無線電。Lake Simcoe開放水面，天氣變化時要謹慎。

**Q：Lake Simcoe有特別嚴格的水上法規嗎？**
A：基本上遵守Transport Canada一般休閒船規定和安大略省省級規定。部分區域可能有特定速限或保護區限制，建議查Lake Simcoe Conservation Authority的最新規定。
...
**為Lake Simcoe或安省其他湖區選Mercury舷外機？**
到 **[mercuryrepower.ca](https://www.mercuryrepower.ca)** 看當前加幣報價，再至 **[hbw.wiki/service](https://hbw.wiki/service)** 讓HBW幫你確認配置是否適合你的釣魚船。
...
如果你是大多倫多的華人船主，你可能已經經歷過這些情境：

**情境 1：「打電話查價格」的迷宮**
你在某個 GTA 經銷商網站上看到一台 Mercury 馬達，網頁上沒有價格。你填了表格，等了一兩天回電。當你終於接到電話，對方問你「你打算用在哪種船？你的預算是多少？」，最後給你一個你還不確定包含什麼的數字。

**情境 2：語言溝通障礙**
經銷商人員講話太快，技術用語太多，你不確定自己理解了什麼是真的需要、什麼是被推銷的。

**情境 3：保固承諾不清楚**
你買了馬達，但保固細節是用英文書面文件給你，你不確定哪些條件會讓保固失效。

**情境 4：售後服務難安排**
維修需要排隊幾週，零件等待時間長，需要重複打電話確認進度。

這些不是因為哪個經銷商「不好」，而是行業普遍的銷售模式造成的。我們選擇用不同的方式做這件事。
...
我們的核心差別：在 [mercuryrepower.ca](https://www.mercuryrepower.ca)，你可以看到完整的安裝報價，包括馬達、配件、完整 rigging、線路、燃油系統連接、試水，全部加幣計價，約 3 分鐘完成。

**沒有電話查價的過程。沒有「填表等回電」。沒有「我們幫您 work something up」。**

這個工具的意義是：你可以在自己的時間、自己的步調思考。你不需要在電話上做決定。

### 2. Mercury Marine Platinum 認證

Mercury 經銷商分多個等級，**Platinum 是最高等級**。具備：
...
對於複雜的 repower（換新馬達）或保固索賠，Platinum 級別的差別會在「多快解決」上明顯體現。
...
我們的客戶基礎中有相當比例的華人船主。對應的服務方式包括：

- **可以用普通話或繁體中文溝通**（請致電 905-342-2153）
- **書面材料部分提供中文**（網站、文章、報價文件）
- **理解新移民的特殊需求**：對加拿大船業規則不熟悉、對 PCOC/PCL/釣魚證有疑問、需要更詳細的解釋
- **不會因為英文不流利而簡化或省略內容**
...
**新 Mercury 馬達銷售**
- 完整馬力範圍 2.5 - 600 HP
- FourStroke、Pro XS、Verado、SeaPro 全產品線
- 完整安裝（rigging、控制、螺旋槳、試水）

**Repower（馬達更換）**
- 舊馬達換新 Mercury
- 完整 rigging 對話：什麼控制器、什麼螺旋槳、什麼安裝高度
- 對於 Rice Lake / Kawartha 區域常見船型，我們的經驗很完整
...
**重要：** 我們**只服務 Mercury 與 Mercruiser 馬達**。Yamaha、Honda、Suzuki 不在我們的服務範圍內。
...
**HBW 銷售船隻嗎？**
我們銷售 Legend 船與部分二手船。如果你想看船的可用情況，請打 905-342-2153 或瀏覽 [harrisboatworks.ca](https://www.harrisboatworks.ca)。

**保固維修需要在 HBW 進行嗎？**
不一定。但 Platinum 級別的 Mercury 經銷商通常處理保固比較快。如果你的馬達是在其他經銷商買的，HBW 也可以做 Mercury 保固維修。

**HBW 有租船嗎？**
有的。9 艘 Legend 船配 Mercury 馬達，在 Rice Lake 上的釣魚季開放。請至 [harrisboatworks.ca/rentals](https://www.harrisboatworks.ca/rentals)。

**HBW 銷售釣魚證嗎？**
不銷售。請至 ontario.ca/fishing 線上購買，或在當地零售商購買。

**HBW 服務非 Mercury 的馬達嗎？**
...
Harris Boat Works | 5369 Harris Boat Works Rd, Gores Landing, ON | Mercury Marine Platinum 認證船廠 | 自 1947 年（船廠），自 1965 年（Mercury 經銷商）`,
    faqs: [
...
從多倫多到 Rice Lake 一日釣魚遊：早上 6-7am 出發，80-90 分鐘車程到 Gores Landing 公共碼頭，租船或自帶船出湖釣 walleye/bass/muskie，下午 5-6pm 返程。一日來回完全可行。需要：安大略釣魚證、PCOC（操作船）、PCL（船 10HP+ 馬達需要）。
...
對住在大多倫多的華人釣友來說，Rice Lake 是「最近的真釣湖」：

- **距離合理：** 80-90 分鐘車程，比 Lake Simcoe 稍遠但釣況更好
- **設備齊全：** 有公共碼頭、租船、餐廳、燃油服務
...
把車開好，裝備檢查：釣竿、餌、釣魚證電子版、PFD（救生衣，如果自帶船）。

走 401 東向。週末早上這段路相對清空，可以維持速度。
...
- 不用拖車（坐車就可以去）
- 適合偶爾去釣或新手測試
- HBW 的租船 9 艘 Legend 船配 Mercury 馬達

### 租船的成本

- 一日租金（依船型而定，請至 [harrisboatworks.ca/rentals](https://www.harrisboatworks.ca/rentals) 看當前價格）
- 燃油（自費）
- 需要 PCOC（船隻操作員卡）

**對偶爾去釣的多倫多華人來說，HBW 租船通常比拖船划算。**
...
**HBW 不銷售釣魚證。** 請預先在 [ontario.ca/fishing](https://www.ontario.ca/fishing) 購買。

**釣魚裝備：**
- 釣竿 × 2-3（一支拖釣、一支底釣、一支備用）
- 釣魚捲線器
- 不同尺寸的鉛塊
- 餌（依季節：jig、軟蟲、亮片、活魚等）
- 釣魚刀
...
對偶爾去釣的釣友來說，租船成本完全可接受。對每月去 2-3 次的釣友，自帶船會更省錢。
...
**HBW 銷售釣魚證嗎？**
不銷售。請至 ontario.ca/fishing 線上購買。
...
如果你需要 Mercury 馬達或船隻服務，請在 [mercuryrepower.ca](https://www.mercuryrepower.ca) 建立報價，或撥打 **905-342-2153**（中文服務可安排）。
...
**PCOC（Pleasure Craft Operator Card，船隻操作員卡）** 是 Transport Canada 規定的證件。法律規定：任何在加拿大水域操作有馬達的休閒船的人，必須持有 PCOC 或同等證明。
...
簡報時間：**通常 30-60 分鐘**，取決於水域複雜度與你的經驗。
...
**如果我有 PCOC，租船會打折嗎？**
通常不會。但你可以省下 Safety Briefing 的時間，更早出船。
...
- [安省華人船主入門：PCOC、PCL、釣魚證](/blog/zh/ontario-chinese-boating-license-fishing-guide)
- [Rice Lake 釣魚完整攻略](/blog/zh/rice-lake-fishing-guide-toronto-chinese)
- [多倫多到 Rice Lake 一日釣魚遊](/blog/zh/toronto-rice-lake-one-day-fishing-trip-zh)
...
---`,
...

  {
    ...
    title: '安大略省 Mercury 換新船外機完整指南：GTA 華人船主必讀',
    description: '你的船外機還值得維修嗎？GTA 華人船主的 Mercury Repower 完整指南：換機時機、選馬力、透明報價，以及 Harris Boat Works 的完整安裝流程。',
    ...
    keywords: ['mercury repower gta', 'gta 華人 mercury', 'mercury 換機 安省', 'gta chinese boater mercury', 'rice lake mercury repower'],
    content: `## 快速答案

如果你的船外機已經老舊、頻繁出問題，換一台新的船外機（Repower）通常比換一艘新船更划算。船身還好的情況下，Repower 讓你用更低的成本獲得全新動力。

Harris Boat Works 是安大略省 Rice Lake 的 Mercury Marine 白金級授權經銷商，1947 年創辦至今第三代經營。你可以在 [mercuryrepower.ca](https://mercuryrepower.ca) 查看透明的加元報價，不需要打電話，不需要談判。
...
Repower 是指在保留船身的前提下，將舊的船外機替換成一台全新的發動機。

對很多船主來說，船身本身狀況還很好，只是發動機已經用了十幾二十年，開始出現各種問題。以下這些症狀，說明你的船外機可能已經到了需要認真考慮換機的階段：

- **冷天啟動困難**，或需要多次嘗試才能啟動
- **燃油消耗明顯增加**，同樣的路程要加更多油
- **馬力下降**，加速變慢，起步吃力
- **維修頻率越來越高**，每個季節都有問題
- **零件難找**，舊型號停產，維修變得複雜且費用高
...
- **完整的馬力系列**：從小型 2.5 HP 到大型高性能機，覆蓋各類船型
- **燃油效率**：新一代 Mercury FourStroke 在燃油效率上有顯著提升
- **耐用可靠**：很多船主使用 Mercury 超過十五年，維修需求相對低
- **零件網絡完善**：作為 Mercury 授權經銷商，HBW 可以快速取得正品零件
- **完整保固**：通過白金級授權經銷商購買，保固完整有效

---

## 選擇新機的馬力

Repower 不只是換一台「差不多大」的機器。選對馬力對於安全、法規合規和實際使用體驗都很重要。

**幾個關鍵原則：**

- 新機的馬力**不能超過船身銘牌（Capacity Plate）允許的最大馬力**
- 用途不同，適合的馬力也不同：釣魚、家庭巡遊和高速水上運動的需求不同
- 選馬力要以**滿載使用情境**為基準，不是空船
- 常去的湖區（Rice Lake、Lake Simcoe、Kawarthas 等）的水況和航行距離也會影響選擇

如果你不確定，先在 [mercuryrepower.ca](https://mercuryrepower.ca) 建立報價，比較不同馬力的配置，再聯繫 HBW 確認適合你船型的具體規格。
...
| 系列 | 適合情境 |
|---|---|
| FourStroke | 大多數家庭和釣魚用途，安靜省油，用途最廣 |
| Pro XS | 注重加速性能和釣魚操控的人 |
| Verado | 大型或高端船，追求靜音和精細操控 |

**對大多數 GTA 華人家庭船主來說，FourStroke 系列是最實際的起點。**

---

## 透明報價：不需要「打電話問」

很多經銷商的網站只寫「致電詢價」。這是一個讓你進入談判流程的方式。
...
1. 選擇機器系列和馬力
2. 選擇配置（控制系統、螺旋槳等）
3. 系統即時顯示**加元（CAD）**真實價格
4. 可以保存或截圖，和家人商量

不需要打電話，不需要議價。所有客戶看到的是同一份價格。
...
**第五步：交付與說明**
說明新機的操作要點、保養週期和保固條款，讓你帶著清楚的認識離開。
...
- **舊機還在保固期內嗎？** 如果是，維修可能更合算
- **維修費用是新機的多少比例？** 如果維修費接近新機的 30–50%，換機值得認真考慮
...
A：安裝新的 Mercury 機器後，Mercury 的原廠保固對新機適用。通過 HBW 這樣的白金級授權經銷商購買，保固完整有效。詳細條款請在購買時確認。

**Q：什麼情況下換新船比 Repower 更合算？**
A：如果船身有結構性問題、嚴重腐蝕、或其他不適合繼續使用的問題，換新船可能更合算。如果只是船外機的問題，船身狀況良好，Repower 通常是更好的選擇。HBW 可以協助評估。

**Q：換機的等待時間大概多久？**
A：視時間段和庫存情況而定，旺季等待時間可能較長。建議提早計劃，不要等到季末或假期前緊急聯繫。
...
`,
    faqs: [
      { question: 'Repower 之後保固怎麼算？', answer: '通過 HBW 白金級授權經銷商購買的 Mercury 新機，享有完整 Mercury 原廠保固。保固期從安裝完成日起算，詳細條款請在購買時確認。' },
      { question: '舊機可以 trade-in 嗎？', answer: '可以。HBW 接受舊機 trade-in，折抵金額視機型、年份、運作狀況而定。建立報價時可同時提交舊機資訊，我們會提供估價。' },
      { question: '換機需要多久？', answer: '一般 3-7 個工作日，視庫存和安裝排程而定。旺季（春季）等待時間可能較長，建議提早預約。' },
