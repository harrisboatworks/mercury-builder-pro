...
// Reuse the markdown rendering approach from the main BlogArticle page
...
export default function FrenchBlogArticlePage() {
  const { slug } = useParams<{ slug: string }>();
  const article = slug ? getFrenchArticleBySlug(slug) : undefined;
      ...
      <main className="container mx-auto px-4 py-12 md:py-16 max-w-4xl">
        ...
        <div className="flex items-center gap-4 text-sm text-muted-foreground mb-6">
          <span className="flex items-center gap-1">
            ...
            {new Date(article.datePublished).toLocaleDateString('fr-CA', { year: 'numeric', month: 'long', day: 'numeric' })}
          </span>
          <span className="flex items-center gap-1">
        ...
        {article.faqs && article.faqs.length > 0 && (
          <section className="mt-12 mb-12">
            <h2 className="text-2xl font-light text-foreground mb-6">Questions fréquentes</h2>
