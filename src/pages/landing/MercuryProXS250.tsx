        ...
        <header className="grid md:grid-cols-2 gap-8 items-center mb-14">
          <div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              Most dealers make you call for a price. Here is ours, in writing. The Mercury Pro XS 250 starts at <strong className="text-foreground">{fromPriceStr} CAD</strong> at Harris Boat Works, a Mercury Premier Dealer on Rice Lake. Four configurations, the same number our sales desk sees. Four-stroke V8, real CAD pricing.
            </p>
