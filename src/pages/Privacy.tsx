...
export default function Privacy() {
  const title = 'Privacy Policy | Harris Boat Works';
  const description = 'How Harris Boat Works collects, uses, and protects your personal information under PIPEDA and Canadian privacy law.';
