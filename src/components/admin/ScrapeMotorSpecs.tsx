...
export function ScrapeMotorSpecs() {
  ...
  const handleBatchScrape = async () => {
    // Legacy batch scraper removed (replaced by Lightspeed DMS direct integration).
    // Kept as a no-op so existing admin pages continue to render.
    toast({
      title: "Not available",
      description: "Per-motor web scraping was removed. Inventory is now synced directly from Lightspeed DMS.",
    });
  };

  const handleSingleScrape = async () => {
    // Legacy per-motor scraper removed (replaced by Lightspeed DMS direct integration).
    toast({
      title: "Not available",
      description: "Per-motor web scraping was removed. Inventory is now synced directly from Lightspeed DMS.",
    });
