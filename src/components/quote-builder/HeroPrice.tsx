  ...
  return (
    <section aria-label="Your price summary" className="rounded-2xl border border-slate-200/70 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
      <div className="flex flex-col gap-1">
        <h2 className="text-sm font-semibold uppercase tracking-[0.12em] text-slate-500 dark:text-slate-400">Your Price</h2>
        <div className="flex flex-wrap items-end gap-x-3">
          <div className="text-4xl md:text-5xl font-semibold tracking-tight text-slate-900 dark:text-white">{money(yourPriceBeforeTax)}</div>
          {totalWithTax != null && (
        ...
        <div className="mt-3 flex flex-wrap items-center gap-3">
          <span
            aria-live="polite"
            className="inline-flex items-center rounded-full bg-emerald-50 px-3 py-1 text-base font-semibold text-emerald-700 ring-1 ring-inset ring-emerald-200 dark:bg-emerald-900/20 dark:text-emerald-300 dark:ring-emerald-800"
          >
