...
export default function MotorDetailsSheet({
  ...
  return (
    <div role="dialog" aria-modal="true" className="fixed inset-0 z-[9999] transform translate3d(0,0,0)">
      <div onClick={onClose} className="absolute inset-0 bg-black/50 backdrop-blur-sm z-[9999]" />
      <div className="absolute inset-x-0 bottom-0 mx-auto w-full max-w-4xl rounded-t-2xl border border-slate-200 bg-white shadow-2xl dark:border-slate-700 dark:bg-slate-900 max-h-[90vh] overflow-y-auto z-[9999] transform translate3d(0,0,0)">
