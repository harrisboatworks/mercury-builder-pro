          ...
          <>
            ...
            <motion.div
              ...
              className={cn(
                ...
                "inset-x-0 bottom-[96px] top-16", // Buffer above unified mobile bar + nudge
            ...
            >
              ...
              {/* Scrollable Content */}
              <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden overscroll-contain p-4 pb-20 modal-content">
