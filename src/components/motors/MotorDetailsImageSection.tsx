  ...
  if (loading) {
    return (
      <div className="space-y-3">
        ...
        <div className="relative h-96 w-full rounded-xl overflow-hidden border border-stone-100 shadow-sm" style={{ background: 'linear-gradient(135deg, #F5F1EA 0%, #ECE4D2 100%)' }}>
