...
const TRUST_FAQ = [
  ...
  },
  {
    ...
    answer: "We carry the full Mercury outboard lineup: portable FourStroke (2.5–20hp), mid-range FourStroke (25–115hp), Command Thrust (40–115hp for pontoons and heavy hulls), Pro XS performance (115–300hp), SeaPro commercial-duty, ProKicker trolling motors (9.9hp/15hp), and FourStroke V8 (250–300hp). We also stock genuine Mercury parts, oils, and accessories."
  },
  {
...
export function MercuryDealerCanadaSEO() {
  ...
  return (
    <Helmet>
      <title>Why Buy from Harris Boat Works: Mercury Dealer FAQ</title>
      <meta
        name="description"
        content="Mercury Marine Premier Dealer on Rice Lake, family-owned since 1947, Mercury dealer since 1965. Real CAD pricing and full Mercury lineup, Ontario."
      />
      <meta
        name="keywords"
      ...
      <meta property="og:title" content="Why Buy from Harris Boat Works: Mercury Dealer FAQ" />
