...
const HOWTO_FAQ = [
  {
    ...
    answer: "Two clocks, and only one of them costs you your summer. Your boat is with us for 2 to 5 days, drop-off to pickup, install, rigging, prop, and a real water test on Rice Lake. Getting the motor is separate: in-stock motors ship immediately; special orders wait at Mercury (the wait depends on the model and current Mercury availability), and your boat stays with you until the motor arrives. Spring (March–May) is busiest, book in fall or winter for priority scheduling."
  },
  {
...
export function HowToRepowerSEO() {
    ...
    "@graph": [
      {
        ...
        "description": "Step-by-step guide to repowering a boat with a new Mercury outboard: quote, sizing, deposit, scheduling, install, lake-test, and pickup. Mercury Marine Premier Dealer · Mercury dealer since 1965 on Rice Lake, Ontario.",
  ...
  return (
    <Helmet>
      ...
      <meta name="twitter:description" content="Mercury Premier Dealer's full repower process, start to finish." />
