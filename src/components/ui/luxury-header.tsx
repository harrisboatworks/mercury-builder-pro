      ...
      >
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 h-full">
          <div className="grid grid-cols-[auto_1fr_auto] md:grid-cols-[1fr_auto_1fr] items-center h-full gap-2 md:gap-6">
            ...
            <div className="hidden md:flex items-center justify-center space-x-3 lg:space-x-6 text-sm text-luxury-gray dark:text-gray-300">
              <div className="flex items-center gap-2 lg:gap-3">
                <img src="/lovable-uploads/5d3b9997-5798-47af-8034-82bf5dcdd04c.png" alt="Mercury CSI Award Winner badge" loading="lazy" className="h-6 lg:h-7 w-auto dark:bg-white dark:p-1 dark:rounded" />
              ...
              <div className="flex items-center gap-2 lg:gap-3">
                <img src="/lovable-uploads/87369838-a18b-413c-bacb-f7bcfbbcbc17.png" alt="Mercury Certified Repower Center badge" loading="lazy" className="h-6 lg:h-7 w-auto dark:bg-white dark:p-1 dark:rounded" />
