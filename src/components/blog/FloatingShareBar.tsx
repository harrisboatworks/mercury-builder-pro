      ...
      <div className="fixed left-4 top-1/2 -translate-y-1/2 z-40 hidden lg:flex flex-col gap-2 animate-fade-in">
        <div className="flex flex-col gap-2 bg-background/95 backdrop-blur-sm border border-border rounded-lg p-2 shadow-lg">
          ...
          <Button
            ...
            className="h-9 w-9 p-0 text-muted-foreground hover:text-[#25D366] hover:bg-[#25D366]/10"
          ...
          <Button
            ...
            className="h-9 w-9 p-0 text-muted-foreground hover:text-[#FF4500] hover:bg-[#FF4500]/10"
          ...
          {canShare ? (
            ...
            <>
              ...
              <Button
                ...
                size="sm"
                onClick={() => openShareWindow(shareLinks.whatsapp, 'whatsapp')}
                className="h-8 w-8 p-0 text-muted-foreground hover:text-[#25D366]"
                aria-label="Share on WhatsApp"
              >
                <WhatsAppIcon />
              </Button>
