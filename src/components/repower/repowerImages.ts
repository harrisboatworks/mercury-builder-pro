...
// TODO: swap in HBW-shot marine photography
// Verified marine photos (yacht hero, underwater CTA) — Unsplash.
export const repowerImages = {
  ...
  finalCta: 'https://images.unsplash.com/photo-1530053969600-caed2596d242?ixlib=rb-4.0.3&auto=format&fit=crop&w=2400&q=80',
};
