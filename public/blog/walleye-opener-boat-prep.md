...
This checklist is the final pass. It assumes you already did spring commissioning in April. If you did not, book that first, then come back here.

---

## What Changes How Much Prep You Need
...
**3. Whether HBW or a shop did your spring commissioning.** Professional commissioning catches things a DIY check can miss.

**4. Your opener-day plans.** A solo trolling run on a familiar stretch of Rice Lake needs less prep than a four-person tournament start.

**5. How far you are trailering.** A boat at a cottage dock needs different prep than a trailer launch 90 minutes from home.

---

## The Two-Week Walleye Opener Prep Checklist
...
- **Test the main motor on the water.** Confirm cooling, charging, throttle response, and shift smoothness. Do not skip this.
- **Test the kicker.** Start it, run it for five to ten minutes, shift it into gear at trolling speed. Stale fuel and gummed carburetors are the most common kicker failures. Better to find out this week than on opener morning.
- **Test trolling at walleye speed**, roughly 1.5 mph. Make sure the kicker holds that speed smoothly.
...
- Pack the cooler, pre-tie leaders, and rig rods.
- Charge all electronics and batteries that need it.
- Confirm launch time and meeting point with your partners if you are not going solo.

### Opener Morning

- **Arrive at the launch early.** Public ramps on opener morning are busy.
...
If you book opener prep at Harris Boat Works, the service includes:

- Final motor inspection and test run (muffs or in water)
- Kicker startup and trolling test
- Battery condition check and replacement if at end of life
- Fuel top-off and stabilizer dose as needed
...
**Stale fuel in the main tank** causes hard starts and rough running. Prevention: stabilize last fall or run the tank down before adding fresh gas in spring.
...
## Pre-Opener Fishing Intel (Zone 17, Rice Lake Area)

**Early season walleye location:** Warmer, shallower bays where spawning has just finished, mouths of streams and creek inlets.

**Techniques that work:** Slow trolling crawler harnesses with the kicker at about 1.5 mph. Jigging in 8 to 15 feet of water. Casting jerk baits along weed edges.

**Weather:** Early May Ontario is variable. Wind builds quickly on Rice Lake. Have rain gear and warm layers regardless of the forecast.
