...
> Pro XS, FourStroke, Verado? 머큐리 세 계열의 차이와 내 보트에 맞는 선택. 머큐리 딜러의 정직한 답변.
...
Pro XS는 같은 4행정 블록을 베이스로 더 높은 RPM, 강화된 흡배기, 토너먼트용 기어비를 적용해 가속과 최고 속도를 끌어올린 버전입니다. FourStroke는 부드러움, 정숙성, 연비에 최적화돼 있어 가족 보트, 폰툰, 일반 낚시 보트에 적합합니다.

### 머큐리 115 Pro XS와 115 FourStroke는 무게가 다른가요?

아니요. 머큐리의 공식 사양상 두 모델 모두 가장 가벼운 구성에서 약 163 kg(359 lb)으로 동일합니다. 머큐리는 115 Pro XS를 동급 최경량 퍼포먼스 115라고 소개합니다.

### 머큐리 Verado는 HBW에서 살 수 있나요?

Verado는 Harris Boat Works에서 상시 재고가 아닌 주문 제작 모델로 취급합니다. 구성기에는 표시되지 않으므로 Verado가 보트에 맞는 경우 905-342-2153으로 전화 주시면 사양을 잡아 주문해 드립니다.
