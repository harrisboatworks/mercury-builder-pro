...
> Boat length does not pick the motor. Start with your capacity plate and the manufacturer's documentation for that exact hull, then match shaft, controls, weight, and...
...
**Lighter, more forgiving, easier to fix. Consider modern welded aluminum (Lund, Princecraft, Legend Tin) when trailering, shallow-water use, and repair options matter to you. Power comes from that specific hull's plate and manufacturer documentation, not from its length.**
...
**Heavier, more comfortable in chop, prettier. Right answer for runabouts, ski boats, and bigger fiberglass cruisers. Power and budget still follow that hull's rated limits and how it is equipped, not a length rule of thumb.**
...
- **Picking horsepower from boat length.**  
  Two 16 ft aluminum boats can carry different plate ratings, different weight limits, and different transom heights. Read the plate and the manufacturer documentation for your exact model and year, then size for the load you actually carry.
- **Treating the maximum rating as the target.**  
  The maximum is a legal and structural ceiling, not advice. Buying to the ceiling adds weight and cost the boat may not need.
- **Skipping the kicker.**  
...
### How do I work out the right horsepower for my aluminum boat?
