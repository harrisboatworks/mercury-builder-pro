---
canonical: https://www.mercuryrepower.ca/blog/boat-repower-process-step-by-step.md
...
description: "What does a repower actually look like from drop-off to pickup? Here's the real process, assessment, installation, rigging, and the on-water test, step by step."
...
# Your Repower, Step by Step: What Actually Happens at the Shop

> What does a repower actually look like from drop-off to pickup? Here's the real process, assessment, installation, rigging, and the on-water test, step by step.

**Category:** HBW Process  
**Published:** 2026-06-06  
**Last updated:** 2026-06-06  
**Read time:** 4 min read  
**Canonical (HTML for humans):** https://www.mercuryrepower.ca/blog/boat-repower-process-step-by-step
...
### What are the steps in a boat repower?

At Harris Boat Works a repower runs through: (1) building an installed-price quote at mercuryrepower.ca, (2) booking the job, (3) drop-off and a full assessment (transom, controls, fuel system, steering), (4) old motor removal, (5) rigging and installation to Mercury spec, (6) a pre-water rigging check, (7) an on-water test on Rice Lake, and (8) pickup with a break-in walk-through.

### What does Harris Boat Works inspect before starting a repower?

Before touching anything, Harris Boat Works inspects transom condition (structural integrity, soft spots, delamination), existing controls and rigging, the fuel system, and the steering. If the inspection changes the job scope, they call you before proceeding, no surprises added after the fact.

### Is the boat tested on the water before I pick it up?

Yes. Every repower gets an on-water test on Rice Lake before pickup. No exceptions. The boat is run through its throttle range to operating temperature, with trim and prop performance verified, so any rigging issue is caught before you get the boat, not at your dock.

### When should I book a repower for a spring launch?

Motor lead times vary by model and season, and spring is busy. If you're planning a spring launch, the time to book is well before ice-out, not the week before. Start with a quote at mercuryrepower.ca and contact Harris Boat Works to confirm availability.
