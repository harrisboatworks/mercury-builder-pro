...
# Licencia de navegación y regulaciones de seguridad en Ontario

> Guía completa sobre la PCOC, PCL, equipo de seguridad obligatorio y regulaciones de navegación en Ontario.
...
No. Son dos certificaciones distintas. Su licencia de conducir no tiene validez en el agua.

### ¿La PCOC es válida en otras provincias?

Sí. Es una certificación federal, válida en todo Canadá.
...
No. Solo para embarcaciones motorizadas. Kayaks, canoas y tablas de paddle (SUP) no están incluidos.

### ¿La PCOC es lo mismo que el PCL?

No. La PCOC es la competencia del operador. El PCL es el registro de la embarcación.
