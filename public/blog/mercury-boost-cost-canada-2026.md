...
No. It is a calibration software upgrade that improves mid-range acceleration response by 5-21%. Peak horsepower at WOT is unchanged.

### Does Boost work on my 300R or 400R?

No. Mercury's official eligibility list does not include 300R, 400R, or V10 (350/400/450R). It covers 175-300 HP FourStroke, 175-300 HP Pro XS, 250-300 HP Verado, 350 HP Verado (within a serial range), and the Mercury Racing 150R.

### How much does Boost cost in Canada?

HBW does not yet have official Mercury Canada MAP pricing. Realistic Canadian retail based on US ($250) and Australian ($395) pricing is in the $300-$500 CAD range, plus install if needed. It is not $2,000.
