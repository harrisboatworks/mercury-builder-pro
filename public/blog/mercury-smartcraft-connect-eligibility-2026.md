...
### Does SmartCraft Connect cost anything monthly?

No subscription for the base features. The gateway module is a one-time hardware cost, the app is free, and the data sync runs over your existing phone data plan. There's an optional Mercury Premium tier with advanced analytics, but it's not required for any of the core features (live data, trip logs, service reminders, fault codes).

### Can I use SmartCraft Connect with a kicker motor?

Not directly. Kickers (9.9 or 15 HP portables) are not SmartCraft-equipped. Your main engine connects, and the kicker just runs separately. There's no eligibility on the kicker side.

### Does it work with twin or triple engines?

Yes for twins, almost always for triples, ask first for quads. One gateway module handles up to four engines depending on the year of the module hardware. Each engine reports independently in the app.

### Will SmartCraft Connect affect my warranty?

No. It's a Mercury-made module installed on a Mercury motor. Mercury treats the install as part of the standard product line. Your factory warranty applies the same way whether you have Connect or not.

### Can I install the gateway myself or do I need a dealer?

You can DIY if you're comfortable with engine harness work. Allow 1-2 hours and basic tools. HBW does the install in roughly 1 to 1.5 hours of bench time if you'd rather not crack the harness yourself.
