...
> Mercury 三大引擎家族 (FourStroke / Pro XS / Verado) 中文对比。HP 范围、最佳用途、典型配置。GTA 华人船主如何选择。
...
- **Left Label:** 钓鱼休闲: FourStroke
- **Left Criteria:** 
  - 莱斯湖, Kawarthas 周末钓鱼或家庭游
  - 载人载货稳定, 不追求极速
  - 在意油耗和保养间隔
  - Pontoon 或铝制钓鱼船首选
- **Left Outcome:** Mercury FourStroke 90 至 200 HP
- **Left Variant:** recommended
- **Right Label:** 速度滑水: Pro XS
- **Right Criteria:** 
  - Bass 锦标赛或专业竞速钓鱼
  - 滑水, 拖管, 拉滑水板
  - 经常满载且需要快速起步
  - 玻璃钢运动艇首选
- **Right Outcome:** Mercury Pro XS 115 至 250 HP
- **Right Variant:** alternative
- **When In Doubt:** 大部分客户买 Pro XS 是看名字, 实际 FourStroke 完全够用还省油。按用途选, 不要按品牌系列选。
...
不是「好或不好」，而是用途不同。Pro XS 偏性能，FourStroke 更通用。
...
不是。它是特定配置/齿轮箱方向，常见价值在重载和 pontoon 使用。
