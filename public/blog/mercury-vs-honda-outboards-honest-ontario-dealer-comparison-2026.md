...
**Refinement, noise, and vibration.** In our experience, many Honda buyers value refinement and report Honda BF motors running quieter and smoother than equivalent Mercury motors in the 9.9 to 90 HP range. Honda's automotive engineering background shows up here.
...
**Cottage kicker and small-engine use case.** Honda BF2.3, BF5, BF8, BF9.9, BF15, BF20 are excellent small motors. Quiet, reliable, well-engineered for the cottage workload.
...
Mercury 9.9 FourStroke is typically a few pounds lighter than equivalent Honda BF9.9, the exact gap varies by model year and shaft length. We rarely hear customers raise weight as a concern at the desk.
...
- [The HBW On-Water Load Test](https://www.mercuryrepower.ca/blog/hbw-on-water-load-test-mercury-repower-advantage-2026) - how we verify every repower
...
Not in 2026. Honda offers 5 years standard plus 3 years HondaCare = up to 8 years. Mercury offers 3 years standard limited (with 3 years corrosion concurrent) plus up to 5 years Mercury Product Protection (MPP) extended = up to 8 years total. The maximum length is equal; the structure differs.
