...
온타리오의 겨울은 보트에 보관하는 모든 것을 시험합니다. Mercury 선외기는 겨울 전에 반드시 제대로 정비해야 합니다, 그렇지 않으면 봄에 균열된 실린더 블록이나 망가진 기어박스를 만날 수 있습니다. 핵심 6단계: 연료 안정화, 엔진 포깅(fogging), 기어 오일 교환, 배터리 분리 보관, 윤활, 덮개 씌우기. 한 단계라도 건너뛰면 봄에 값비싼 수리가 기다립니다.

전문 겨울 정비 예약: [hbw.wiki/service](https://hbw.wiki/service)
...
엔진 내부의 수분이 영하에서 얼면 부피가 약 9% 팽창합니다. 실린더 블록은 이 압력을 버티지 못합니다. 겨울 정비는 선택이 아니라 필수입니다.

---

## 겨울 정비가 필요한 이유, 건너뛰면 생기는 일

| 건너뛴 항목 | 발생 가능한 손상 |
|---|---|
| 연료 안정화 | 연료 계통 막힘, 봄에 시동 불량 |
| 포깅(fogging) | 실린더 내벽 녹 발생, 시동 어려움 |
| 기어 오일 교환 | 기어박스 부식, 씰 손상 |
| 배터리 관리 | 배터리 방전·동결, 영구 손상 |
| 윤활 | 조향 장치 고착, 봄에 부품 파손 |
| 수분 배출 | 실린더 블록 균열 (가장 심각한 손상) |

---

## 겨울 정비 준비물

정비를 시작하기 전에 아래 소모품을 준비하세요. 대부분 Canadian Tire나 마린 부품점에서 구할 수 있습니다:

- Mercury Quickstor 또는 동급 연료 안정제
- Mercury Storage Seal 포깅 오일 (또는 Mercury Premium Fogging Oil)
- Mercury 고성능 기어 루브 (모터 크기에 따라 용량 다름)
- 기어 루브 드레인 플러그 가스켓 (매년 교체 권장)
- 점화 플러그 소켓 (모터 매뉴얼에서 사이즈 확인)
- 점화 플러그 나사산용 anti-seize 컴파운드
- 해양용 그리스
- 수세미, 천, 버킷
- 플러시 이어머프 (호스 연결용)
...
### 1단계: 연료 안정화, 에탄올이 가장 큰 위협

**왜 중요한가:** 북미 주유소의 일반 휘발유(E10)에는 최대 10% 에탄올이 포함됩니다. 에탄올은 보관 중 수분을 흡수하고, 30~60일 후부터 연료 분리와 부식을 일으킵니다. 5~6개월 보관하는 온타리오 겨울 동안 안정제 없이 두면 봄에 시동이 거의 걸리지 않을 수 있습니다.

**방법:**
1. 마지막 출항 시, 출발 전에 연료 탱크에 안정제를 추가합니다 (보통 10L당 30~40ml, 병의 지시를 따르세요).
2. 안정제를 추가한 후 최소 10분 이상 엔진을 작동시킵니다, 안정제가 연료 라인, 인젝터 또는 기화기까지 순환해야 합니다.
3. 엔진을 작동하지 않고 탱크에만 넣으면 연료 계통 안쪽이 보호되지 않습니다.

**더 좋은 방법:** HBW에서는 에탄올 무첨가 연료를 현장 판매합니다. 시즌 마지막에 에탄올 무첨가 연료로 채우면 연료 안정제 사용보다 훨씬 효과적입니다.

**하지 말아야 할 것:** 탱크를 완전히 비우는 것은 현대 FourStroke 모터에 권장되지 않습니다. 연료 씰과 가스켓이 건조해질 수 있습니다.

---

### 2단계: 냉각 계통 플러시 (수분 배출)

마지막 운행 후, 깨끗한 담수로 냉각 계통을 플러시합니다.

1. 플러시 이어머프를 호스에 연결하고 하부 유닛의 냉각 흡입구에 장착합니다.
2. 엔진을 아이들 상태로 최소 5분간 작동시킵니다.
3. 엔진을 끈 후 완전히 기울여서 냉각 계통의 잔여 수분이 배출되도록 합니다.

**중요:** 엔진이 작동 온도에 도달해야 서모스탯이 열리고 전체 냉각 회로가 플러시됩니다. 차가운 상태에서 2분만 돌리는 것으로는 충분하지 않습니다.

엔진은 수직 또는 약간 기울인 자세로 보관해 중력에 의해 잔수가 빠져나올 수 있도록 합니다.

---

### 3단계: 엔진 내부 포깅(Fogging)

**왜 중요한가:** 엔진을 끄면 실린더 내벽의 보호 유막이 사라집니다. 5~6개월 동안 노출된 금속 표면에 녹이 생길 수 있습니다. 포깅 오일은 실린더 내벽에 방청 유막을 형성합니다.

**FourStroke 모터 일반적인 절차:**
1. 플러시 이어머프를 연결하고 엔진을 아이들 상태로 작동합니다.
2. 에어박스 커버를 제거하여 흡기구에 접근합니다.
3. 포깅 오일을 흡기구에 짧게 분사합니다, 연기가 나는 것은 정상입니다.
4. 배기구에서 오일 연기가 지속적으로 나올 때까지 계속합니다.
5. 포깅 오일을 분사하면서 엔진을 끕니다, 이렇게 하면 실린더 내벽에 오일이 남습니다.

**주의:** 절차는 모터 모델마다 다릅니다. 반드시 해당 모터의 Mercury 오퍼레이터 매뉴얼을 확인하세요. 잘못된 포깅은 엔진을 손상시킬 수 있습니다. 자신이 없다면 딜러에게 맡기는 것이 안전합니다.

---

### 4단계: 기어 오일(Gear Lube) 교환

**왜 중요한가:** 기어박스 내부의 기어 오일은 한 시즌 사용 후 수분과 금속 마모 입자를 함유합니다. 수분이 든 기어 오일은 저온에서 기어와 씰을 부식시킵니다.

**절차:**
1. 기어박스 하단의 드레인 플러그부터 제거하고, 그 다음 상단 플러그를 제거합니다.
2. 구 기어 오일이 완전히 배출될 때까지 기다립니다.
3. **배출된 오일을 확인합니다.** 우유색이나 거품이 있으면 씰에서 수분이 침투한 것입니다, 씰 점검이 필요합니다.
4. 기어 오일 펌프로 하단 구멍에서 채워 넣어 상단 구멍에서 나올 때까지 주입합니다.
5. 상단 플러그를 먼저, 그다음 하단 플러그를 설치합니다. 가스켓을 새것으로 교체합니다.

---

### 5단계: 모든 가동 부위 윤활

조향 장치, 틸트/트림 피벗, 스위블 브래킷, 프로펠러 샤프트 등 모든 가동 부위에 해양용 그리스를 주입합니다.

모터 매뉴얼의 윤활 다이어그램을 참고하세요. 자주 간과되는 부위:
- 스티어링 케이블 끝단
- 틸트 튜브
- 프로펠러 샤프트 (일반 그리스가 아닌 anti-seize 컴파운드 사용)

프로펠러 샤프트에 부식 방지 처리를 하지 않으면 겨울 동안 프로펠러가 샤프트에 달라붙어 봄에 제거가 매우 어려워집니다.

---

### 6단계: 배터리 분리 보관

배터리를 보트에 그대로 두고 겨울을 나면 안 됩니다. 저온은 납축 배터리의 자가 방전을 가속시키며, 완전 방전된 배터리는 동결되어 영구 손상될 수 있습니다.

**올바른 방법:**
1. 배터리를 보트에서 분리합니다.
2. 서늘하고 건조하며 영하가 되지 않는 실내에 보관합니다.
3. **배터리 텐더(트리클 충전기)에 연결합니다.** 이것은 과충전 없이 겨울 내내 충전 상태를 유지해 배터리 수명을 크게 늘립니다.

배터리 텐더 없이 보관한 배터리는 봄에 용량이 크게 줄어 있을 수 있습니다.

---

## 덮개(Cover) 씌우기와 보관 자세

- 통기구가 있는 모터 커버를 사용합니다. 비통기성 비닐로 완전히 밀봉하면 결로가 생깁니다.
- 모터는 수직 자세 또는 제조사 권장 각도로 보관해 잔여 수분이 완전히 배출되도록 합니다.
- 실내 보관이 가능하다면 이상적입니다. 야외 보관 시에는 방수·통기 커버로 엔진과 선체를 보호합니다.

---

## DIY vs. 전문 정비: 어떤 것을 선택해야 할까요?

### DIY가 현실적인 경우
- 기계 작업에 자신이 있는 경우
- 60HP 이하의 소형 모터
- 차고나 작업 공간에서 모터에 접근하기 쉬운 경우
- 작동 중 모터를 잠시 가동할 수 있는 환경 (플러시 이어머프 사용 가능)

### 전문 정비가 더 나은 경우
- 겨울 정비를 처음 해보는 경우
- 대형 모터 (특히 V6, V8, Verado)
- 냉각 계통이 완전히 비워졌는지 확실하지 않은 경우
- 시간이 촉박하거나 서두르게 될 것 같은 경우

잘못된 겨울 정비의 결과는 균열된 파워헤드일 수 있습니다. 전문 정비 비용은 그보다 훨씬 저렴합니다.

HBW에서는 2025년 가을 시즌에 584건의 겨울 정비를 완료했습니다. Mercury 전 모델에 경험이 풍부한 기술자들이 작업합니다.

**엔진 수리의 경우, 저희는 Mercury 및 Mercruiser만 서비스합니다.**

---

## 자주 묻는 질문 (FAQ)

**겨울 정비를 하지 않으면 반드시 손상이 발생하나요?** 
보장할 수는 없지만, 온타리오 겨울은 영하 20°C 이하까지 내려가며 냉각 계통에 수분이 남아 있으면 얼어서 블록이 균열될 수 있습니다. 리스크가 큽니다.

**포깅 오일은 어디서 구할 수 있나요?** 
Canadian Tire, 마린 부품점, 또는 Mercury 딜러에서 구할 수 있습니다. HBW에서도 부품을 구입할 수 있습니다. Mercury Storage Seal 또는 Mercury Premium Fogging Oil을 권장합니다.

**기어 오일이 하얀색(우유색)으로 나왔습니다. 그냥 새것으로 채워도 되나요?** 
아닙니다. 우유색 기어 오일은 씰에서 수분이 침투한 것을 의미합니다. 씰을 수리하지 않으면 새 오일도 곧 우유색이 됩니다. 씰 점검이 필요합니다.

**배터리 텐더(트리클 충전기)가 없으면 어떻게 하나요?** 
Canadian Tire에서 비교적 저렴하게 구입할 수 있습니다. 배터리 교체 비용보다 훨씬 저렴합니다. 배터리를 보트에 그냥 두지 마세요.

**HBW에서 한국어 서비스를 제공하나요?** 
HBW 팀은 영어로 소통합니다. 한국어 통역 서비스는 제공하지 않지만, 한인 고객을 환영하며 최선을 다해 도와드립니다. 서비스 예약 양식을 통해 연락해 주세요.
...
- **웹사이트:** [harrisboatworks.ca](https://www.harrisboatworks.ca)
- **에탄올 무첨가 연료:** 현장 판매
- **모터 견적:** [mercuryrepower.ca](https://www.mercuryrepower.ca)

---

## 관련 영문 게시물 (Related English Posts)
...
### Why will my Mercury outboard not start after winter?

Common causes include weak battery, loose/corroded terminals, stale fuel, closed tank vent, primer bulb issues, kill switch, neutral safety switch, or fuel system problems.

### Can old gas stop an outboard from starting?

Yes. Stale or contaminated fuel can cause hard starting, no-start, rough running, or stalling after storage.

### Should I keep cranking it?

No. Repeated cranking can drain the battery and make diagnosis harder. Check basics, then stop and book service if it does not start.
