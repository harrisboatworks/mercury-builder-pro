...
| Engine | Bare Motor | Principal With $349 Fee | 5.48% APR (240-mo amortization) |
|---|---|---|---|
...
Qualified buyers may be eligible for $0 down. Approval, down payment, and all terms are confirmed by the lender.

### Can I pay off the loan early without a penalty?

Prepayment terms are confirmed in the signed lender disclosure. Do not rely on a website example for contract-specific terms.
