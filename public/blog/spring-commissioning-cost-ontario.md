...
> What spring commissioning really costs in Ontario, from 9,540 spring work orders: the flat startup rate, what's included, and why the fall service decides the spring...
...
## What Spring Commissioning Includes

For a boat that was winterized and serviced in fall, spring startup is a wake-up call, not surgery:

- Reconnect the battery (it stayed in the boat, disconnected, all winter) and test charge
- Fresh fuel check and prime
- Start, warm, and check: telltale stream, idle quality, shift and throttle
- Look over lines, bilge, lights, and safety gear
- Confirm the fall recommendations line got addressed

That's roughly an hour of work, which is why the flat labour was $99 at our counter last season (as of July 2026; confirmed when you book). Parts only enter the bill if something needs attention: a battery at end-of-life, a fuel filter, wear items of that sort.
...
| Your fall | Your spring looks like | Typical spring cost |
|---|---|---|
| Winterized AND serviced in fall | Startup, checks, launch | ~$99 labour + only-as-needed parts |
...
Even on well-kept boats, spring finds things. The usual suspects from our work orders:
...
- **The impeller**, on its interval. Spring is the natural time; our [766-job impeller dataset](/blog/mercury-impeller-replacement-when-they-fail) shows why skipping it ruins Julys, not Aprils.

---

## What HBW checks before your boat launches

Spring startup at our shop ends on the water, not on the invoice: motor started, warmed, and checked before the boat is called ready, with anything we find written on your file. We've been running this play since 1947, and 9,540 spring jobs in the system say the quiet springs belong to the boats we saw in October. Book fall and spring together and your boat gets both ends of the system.
...
- HBW service records, Rice Lake: 9,540 spring work orders, 2013-2026 (flat rates and medians from the 2024-25 season)
...
For a boat that was winterized and serviced in fall, our flat spring-startup labour was $99 last season (before HST; as of July 2026; confirmed when you book), with parts only as needed. Boats that skipped fall service pay for the deferred service on top, in the busiest month of the year.
...
Most of it, yes; our spring checklist walks every step. The shop earns its hour when something's off: hard starts, weak telltale, rough idle. If the wake-up reveals a problem, that's the moment for professional eyes.
