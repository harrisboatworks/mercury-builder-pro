...
> When a Mercury outboard hits a major repair decision, owners face three real options. A Mercury Platinum dealer's honest framework for choosing between repair...
...
Get two estimates from Mercury dealers. Ask each one to write out specifically what parts are being replaced and why. Avoid open-ended "we'll see what we find" estimates that have no upper bound.
