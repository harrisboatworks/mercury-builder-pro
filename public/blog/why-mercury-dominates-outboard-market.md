...
### Why does Mercury have such a large market share?

Mercury Marine is the world's largest outboard manufacturer, with 50–80% share of outboards at major international boat shows. Their position widened after BRP discontinued Evinrude in 2020. Continuous innovation (V12 600HP, SmartCraft, Avator electric), a full horsepower range, and strong dealer support keep them ahead of competitors.

### What makes the Verado V12 600 HP special?

The V12 Verado is a naturally aspirated 7.6L V12 with a two-speed automatic transmission, steerable gearcase, and extremely low noise and vibration. No competitor matches its combination of 600 HP, integrated features, and refinement. It changed what people thought an outboard could be.

### How does SmartCraft benefit boat owners?

SmartCraft ties engines, helm displays, and mobile devices into one integrated network. VesselView shows engine data on helm screens, SmartCraft Connect pushes that data to Garmin and Raymarine chartplotters, and the Mercury app provides remote monitoring. Features like Active Trim and Troll Control add automated convenience.
