...
- **Boat type:** 23-foot cabin / walkaround
- **Region:** Rice Lake / Trent system
- **Scenario:** Twin-to-single big-block consolidation
- **HP jump:** Twin 115 → single 300

## Before → After

- **Before:** Twin 115 HP FourStrokes (~25 years old)
- **After:** Single Mercury 300 HP V8 Verado or Pro XS 4.6L
...
- HTML page (canonical for humans): https://www.mercuryrepower.ca/case-studies/twin-to-single-big-block
