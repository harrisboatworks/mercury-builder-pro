...
- **Boat type:** Small utility / cedar-strip boat
- **Region:** Ontario cottage country
- **Scenario:** Small utility / cedar-strip setup
- **HP jump:** Portable refresh

## Before → After

- **Before:** Legacy small portable outboard
- **After:** Mercury 9.9HP FourStroke
...
- HTML page (canonical for humans): https://www.mercuryrepower.ca/case-studies/cedar-strip-9-9-fourstroke
