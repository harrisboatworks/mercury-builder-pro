---
canonical: https://www.mercuryrepower.ca/locations/ajax-mercury-dealer
...
## FAQs
### How far is Harris Boat Works from Ajax?

About 75 minutes east via Hwy 401 — exit at Cobourg, then north to Gores Landing on Rice Lake.

### Do you come to Ajax for service or installs?

No. We are a shop-based Mercury dealer — no mobile service, no driveway or marina visits. All work is done at Gores Landing.

### Can Ajax customers get a quote without calling?

Yes. Build a complete CAD quote at /quote/motor-selection first, then we confirm by phone.

## Service boundary
Harris Boat Works does not perform mobile service, on-site installs, or driveway/marina visits in Ajax. Customers from Ajax bring their boat to our Gores Landing shop, or pick up a loose Mercury motor for self-install.
## Notes
- All pricing in CAD. Final price confirmed by Harris Boat Works.
- Verado is special-order only — not in default inventory.
- HTML page (canonical for humans): https://www.mercuryrepower.ca/locations/ajax-mercury-dealer
