...
- Cottage utility boats
## Popular Mercury HP ranges
- 5–9.9 HP sailboat auxiliary
- 9.9–25 HP kicker
- 60–115 HP cottage repower
...
## FAQs
### How far is Harris Boat Works from Pickering?

About 80 minutes east on the 401, exiting at Cobourg.
...
Yes. We carry the full Mercury FourStroke lineup from 2.5 HP up.

## Service boundary
Harris Boat Works does not perform mobile service, on-site installs, or driveway/marina visits in Pickering. Customers from Pickering bring their boat to our Gores Landing shop, or pick up a loose Mercury motor for self-install.
## Notes
- All pricing in CAD. Final price confirmed by Harris Boat Works.
- Verado is special-order only, not in default inventory.
- HTML page (canonical for humans): https://www.mercuryrepower.ca/locations/pickering-mercury-dealer
