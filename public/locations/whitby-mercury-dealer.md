...
## Common local boats
- Lake Ontario fishing and runabouts
- Scugog bass and walleye boats
- Cottage pontoons trailered north
## Popular Mercury HP ranges
- 9.9–25 HP kicker / sailboat auxiliary
- 60–115 HP fishing repower
...
## FAQs
### How far is Harris Boat Works from Whitby?

About 70 minutes east via Hwy 401, exit at Cobourg, then County Rd 18 north to Gores Landing.

### Do you deliver Mercury outboards to Whitby?

No. Pickup only at Gores Landing. Bring the boat for installation, or pick up a loose Mercury motor for self-install.

### Can I finalize a Whitby Mercury quote online?

You can build a complete itemized CAD quote online and we confirm the build by phone before pickup.
...
- HTML page (canonical for humans): https://www.mercuryrepower.ca/locations/whitby-mercury-dealer
