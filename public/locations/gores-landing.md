...
region_type: city
keyword: "mercury repower gores landing"
...
- Coordinates: 44.121684, -78.241502
...
No. We're pickup-only at the shop, even for local customers. The motor is rigged, propped, and water-tested on Rice Lake before you pick up at our dock.
...
Yes. If your current motor still runs, you can bring the boat to our docks under its own power for the repower drop-off. Otherwise it's a short tow.

### What HP Mercury do Gores Landing boats run?

Locals run the full range. Tiller FourStroke 9.9–25 HP on tinnies, mid-range FourStroke 60–115 HP on runabouts, Pro XS 175 HP on bass boats and pontoons. Big-block FourStroke 150–200 HP on heavier fiberglass.

## Service boundary
Harris Boat Works does not perform mobile service, on-site installs, or driveway/marina visits in Gores Landing. Customers from Gores Landing bring their boat to our Gores Landing shop, or pick up a loose Mercury motor for self-install.
## Notes
- All pricing in CAD. Final price confirmed by Harris Boat Works.
- Verado is special-order only, not in default inventory.
- HTML page (canonical for humans): https://www.mercuryrepower.ca/locations/gores-landing
