---
canonical: https://www.mercuryrepower.ca/locations/bobcaygeon
...
region: "Bobcaygeon"
region_type: city
keyword: "mercury repower bobcaygeon"
...
## FAQs
### How far is Harris Boat Works from Bobcaygeon?

About 75 minutes south, roughly 80 km, to Gores Landing on the south shore of Rice Lake.

### Do you deliver Mercury motors to Bobcaygeon or Pigeon Lake cottages?

No. We are pickup-only at Gores Landing. We rig and water-test on Rice Lake, then you drive south to pick up.

### What HP Mercury is common for Pigeon and Sturgeon Lake boats?

Cruising boats run mid-range FourStroke 90–150 HP. Performance pontoons and bigger fiberglass run Pro XS V8 4.6L 175–250 HP, often with the Boost option for 25 extra horsepower on demand.
...
Yes. If you want the boat ready for spring, January to April is the best booking window. Ice-out on Rice Lake is usually mid-April.

## Service boundary
Harris Boat Works does not perform mobile service, on-site installs, or driveway/marina visits in Bobcaygeon. Customers from Bobcaygeon bring their boat to our Gores Landing shop, or pick up a loose Mercury motor for self-install.
## Notes
- All pricing in CAD. Final price confirmed by Harris Boat Works.
- Verado is special-order only, not in default inventory.
- HTML page (canonical for humans): https://www.mercuryrepower.ca/locations/bobcaygeon
