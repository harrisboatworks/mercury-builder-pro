...
region_type: city
keyword: "mercury repower northumberland county"
...
## FAQs
### Is Harris Boat Works in Northumberland County?

Yes. We are in Gores Landing, on the south shore of Rice Lake, inside Northumberland County. Address: 5369 Harris Boat Works Rd, K0K 2E0.

### How far is HBW from Cobourg, Port Hope, or Brighton?

Cobourg is ~25 minutes, Port Hope ~30 minutes, Brighton ~40 minutes. Most Northumberland residents are within 30 minutes of Gores Landing.

### Do you deliver Mercury motors within Northumberland County?

No. We are pickup-only at Gores Landing, even for in-county customers. We rig, water-test on Rice Lake, and you drive to us.

### What HP Mercury do Northumberland boaters typically repower with?

Most Northumberland repowers are for Rice Lake boats: FourStroke 60–115 HP for runabouts and aluminum, Pro XS 115–175 HP for bass boats and faster fiberglass.

### Can Northumberland County customers finance a repower?

Yes. Financing runs 7.99% APR over $10,000 and 8.99% APR under $10,000, OAC. We finalize numbers at quote. Current promo: 5.48% APR through Dec 31, 2026 via the Mercury TD Always On program (OAC).

## Service boundary
Harris Boat Works does not perform mobile service, on-site installs, or driveway/marina visits in Northumberland County. Customers from Northumberland County bring their boat to our Gores Landing shop, or pick up a loose Mercury motor for self-install.
## Notes
- All pricing in CAD. Final price confirmed by Harris Boat Works.
- Verado is special-order only, not in default inventory.
- HTML page (canonical for humans): https://www.mercuryrepower.ca/locations/northumberland-county
