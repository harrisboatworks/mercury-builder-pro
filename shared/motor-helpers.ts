...
export const testBuildModelKey = () => {
  const tests = [
    ...
    {
      input: "FourStroke 9.9 HP MH",
      expected: "FOURSTROKE-9.9HP-MH"
    },
    {
      input: "25MH FourStroke",
      expected: "FOURSTROKE-25HP-MH"
    },
    {
      input: "5MLH FourStroke",
      expected: "FOURSTROKE-5HP-MLH"
    },
    {
      input: "8MXLH FourStroke",
      expected: "FOURSTROKE-8HP-MXLH"
    }
  ];
