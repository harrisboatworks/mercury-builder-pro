...
-- Insert any completely missing Command Thrust models from the official pricing
-- These are models that don't exist in our database at all
...
-- 4 MH Command Thrust FourStroke (missing completely)
...
-- ProKicker models that might be missing
...
-- Update model key generation to handle Command Thrust and ProKicker designations
-- This ensures proper model keys for stock matching