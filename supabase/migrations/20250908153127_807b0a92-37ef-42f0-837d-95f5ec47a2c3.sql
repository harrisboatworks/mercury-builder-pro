-- Update database functions to include proper security settings
-- Fix search_path issues identified in security review
...
-- Update validate_user_data_access function with proper search_path
DROP FUNCTION IF EXISTS public.validate_user_data_access(text, text);
...
-- Update audit_orphaned_customer_data function with proper search_path  
DROP FUNCTION IF EXISTS public.audit_orphaned_customer_data();
...
-- Update enforce_customer_quotes_user_id function with proper search_path
DROP FUNCTION IF EXISTS public.enforce_customer_quotes_user_id();
...
-- Update enforce_customer_xp_user_id function with proper search_path
DROP FUNCTION IF EXISTS public.enforce_customer_xp_user_id();
...
-- Update enforce_quotes_user_id function with proper search_path
DROP FUNCTION IF EXISTS public.enforce_quotes_user_id();
