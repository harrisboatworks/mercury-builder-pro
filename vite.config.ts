...
export default defineConfig(({ mode }) => ({
  ...
  resolve: {
    alias: {
      ...
      'unicode-trie': path.resolve(__dirname, './src/lib/vendor/unicode-trie-compat.ts'),
      'brotli/decompress.js': path.resolve(__dirname, './src/lib/vendor/brotli-decompress-compat.ts'),
      'js-md5': path.resolve(__dirname, './src/lib/vendor/js-md5-compat.ts'),
      'abs-svg-path': path.resolve(__dirname, './src/lib/vendor/abs-svg-path-compat.ts'),
      'parse-svg-path': path.resolve(__dirname, './src/lib/vendor/parse-svg-path-compat.ts'),
      'normalize-svg-path': path.resolve(__dirname, './src/lib/vendor/normalize-svg-path-compat.ts'),
      'hsl-to-hex': path.resolve(__dirname, './src/lib/vendor/hsl-to-hex-compat.ts'),
      'media-engine': path.resolve(__dirname, './src/lib/vendor/media-engine-compat.ts'),
    },
  },
}));
