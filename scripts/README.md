...
| `public-function-pair-attestation-probe.mjs` | Offline-tested #542 probe CLI. Default refuses live OpenAI. Codex injects adapters in a credential-owning environment. Never writes `ATTESTED`. Logic in `lib/public-function-pair-attestation.mjs`. |
