...
const routes = [
  ...
  // ============================================================
  {
    ...
    description: 'Live CAD pricing on every Mercury outboard we stock, 2.5 to 600 HP. Real dealer prices from a Mercury Premier dealer on Rice Lake. No forms, no games.',
