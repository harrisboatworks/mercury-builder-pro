...
export function loadCanonicalPricing() {
  ...
  const ranges = {
    ...
    prokicker_9_9: bracket(skus, (s) => s.hp === 9.9 && /ProKicker/i.test(s.model)),
    fourstroke_25: bracket(skus, (s) => s.hp === 25 && s.family === 'FourStroke'),
    fourstroke_40: bracket(skus, (s) => s.hp === 40 && s.family === 'FourStroke'),
    fourstroke_60: bracket(skus, (s) => s.hp === 60 && s.family === 'FourStroke'),
    fourstroke_90: bracket(skus, (s) => s.hp === 90 && s.family === 'FourStroke'),
    fourstroke_115: bracket(skus, (s) => s.hp === 115 && s.family === 'FourStroke'),
    fourstroke_150: bracket(skus, (s) => s.hp === 150 && s.family === 'FourStroke'),
    fourstroke_175: bracket(skus, (s) => s.hp === 175 && s.family === 'FourStroke'),
    fourstroke_200: bracket(skus, (s) => s.hp === 200 && s.family === 'FourStroke'),
    fourstroke_250: bracket(skus, (s) => s.hp === 250 && s.family === 'FourStroke'),
    proxs_150: bracket(skus, (s) => s.hp === 150 && s.family === 'ProXS'),
    proxs_175: bracket(skus, (s) => s.hp === 175 && s.family === 'ProXS'),
    proxs_200: bracket(skus, (s) => s.hp === 200 && s.family === 'ProXS'),
    proxs_225: bracket(skus, (s) => s.hp === 225 && s.family === 'ProXS'),
    proxs_250: bracket(skus, (s) => s.hp === 250 && s.family === 'ProXS'),
    proxs_300: bracket(skus, (s) => s.hp === 300 && s.family === 'ProXS'),
    hp_75_to_115_all: bracket(skus, (s) => s.hp >= 75 && s.hp <= 115),
    hp_150_to_200_all: bracket(skus, (s) => s.hp >= 150 && s.hp <= 200),
    hp_175_to_300_all: bracket(skus, (s) => s.hp >= 175 && s.hp <= 300),
    hp_250_to_300_all: bracket(skus, (s) => s.hp >= 250 && s.hp <= 300),
